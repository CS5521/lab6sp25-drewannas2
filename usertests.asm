...
iputtest(void)
{
  ...
  if(mkdir("iputdir") < 0){
      ...
      22:	e8 3b 40 00 00       	call   4062 <mkdir>
    ...
    exit();
      40:	e8 b5 3f 00 00       	call   3ffa <exit>
  }
  if(chdir("iputdir") < 0){
      45:	c7 04 24 69 45 00 00 	movl   $0x4569,(%esp)
      4c:	e8 19 40 00 00       	call   406a <chdir>
    ...
    exit();
      6a:	e8 8b 3f 00 00       	call   3ffa <exit>
  }
  if(unlink("../iputdir") < 0){
      6f:	c7 04 24 95 45 00 00 	movl   $0x4595,(%esp)
      76:	e8 cf 3f 00 00       	call   404a <unlink>
    ...
    exit();
      94:	e8 61 3f 00 00       	call   3ffa <exit>
  }
  if(chdir("/") < 0){
      99:	c7 04 24 ba 45 00 00 	movl   $0x45ba,(%esp)
      a0:	e8 c5 3f 00 00       	call   406a <chdir>
    ...
    exit();
      be:	e8 37 3f 00 00       	call   3ffa <exit>
  }
...
exitiputtest(void)
{
  ...
  pid = fork();
      f5:	e8 f8 3e 00 00       	call   3ff2 <fork>
  ...
  if(pid < 0){
    ...
    exit();
     118:	e8 dd 3e 00 00       	call   3ffa <exit>
  }
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     12e:	e8 2f 3f 00 00       	call   4062 <mkdir>
     ...
     147:	e8 2e 40 00 00       	call   417a <printf>
      exit();
     14c:	e8 a9 3e 00 00       	call   3ffa <exit>
    }
    if(chdir("iputdir") < 0){
     151:	c7 04 24 69 45 00 00 	movl   $0x4569,(%esp)
     158:	e8 0d 3f 00 00       	call   406a <chdir>
     ...
     171:	e8 04 40 00 00       	call   417a <printf>
      exit();
     176:	e8 7f 3e 00 00       	call   3ffa <exit>
    }
    if(unlink("../iputdir") < 0){
     17b:	c7 04 24 95 45 00 00 	movl   $0x4595,(%esp)
     182:	e8 c3 3e 00 00       	call   404a <unlink>
     ...
     19b:	e8 da 3f 00 00       	call   417a <printf>
      exit();
     1a0:	e8 55 3e 00 00       	call   3ffa <exit>
    }
    exit();
     1a5:	e8 50 3e 00 00       	call   3ffa <exit>
  }
  wait();
     1aa:	e8 53 3e 00 00       	call   4002 <wait>
...
openiputtest(void)
{
  ...
  if(mkdir("oidir") < 0){
     ...
     1e8:	e8 75 3e 00 00       	call   4062 <mkdir>
    ...
    exit();
     206:	e8 ef 3d 00 00       	call   3ffa <exit>
  }
  pid = fork();
     20b:	e8 e2 3d 00 00       	call   3ff2 <fork>
  ...
  if(pid < 0){
    ...
    exit();
     22e:	e8 c7 3d 00 00       	call   3ffa <exit>
  }
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     248:	e8 ed 3d 00 00       	call   403a <open>
    ...
    if(fd >= 0){
     ...
     266:	e8 0f 3f 00 00       	call   417a <printf>
      exit();
     26b:	e8 8a 3d 00 00       	call   3ffa <exit>
    }
    exit();
     270:	e8 85 3d 00 00       	call   3ffa <exit>
  }
  sleep(1);
     275:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     27c:	e8 09 3e 00 00       	call   408a <sleep>
  if(unlink("oidir") != 0){
     281:	c7 04 24 2b 46 00 00 	movl   $0x462b,(%esp)
     288:	e8 bd 3d 00 00       	call   404a <unlink>
    ...
    exit();
     2a6:	e8 4f 3d 00 00       	call   3ffa <exit>
  }
  wait();
     2ab:	e8 52 3d 00 00       	call   4002 <wait>
...
opentest(void)
{
  ...
  fd = open("echo", 0);
     ...
     2f1:	e8 44 3d 00 00       	call   403a <open>
  ...
  if(fd >= 0){
    ...
    exit();
     356:	e8 9f 3c 00 00       	call   3ffa <exit>
  }
...
writetest(void)
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     39c:	e8 99 3c 00 00       	call   403a <open>
  ...
  for(i = 0; i < 100; i++){
    ...
    exit();
     3e0:	e8 15 3c 00 00       	call   3ffa <exit>
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     3fb:	e8 1a 3c 00 00       	call   401a <write>
     ...
     41c:	e8 59 3d 00 00       	call   417a <printf>
      exit();
     421:	e8 d4 3b 00 00       	call   3ffa <exit>
    }
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     43c:	e8 d9 3b 00 00       	call   401a <write>
     ...
     45d:	e8 18 3d 00 00       	call   417a <printf>
      exit();
     462:	e8 93 3b 00 00       	call   3ffa <exit>
  for(i = 0; i < 100; i++){
  ...
  i = read(fd, buf, 2000);
     ...
     4dd:	e8 30 3b 00 00       	call   4012 <read>
  ...
  if(i == 2000){
    ...
    exit();
     505:	e8 f0 3a 00 00       	call   3ffa <exit>
  ...
  close(fd);
     ...
     525:	e8 f8 3a 00 00       	call   4022 <close>

  if(unlink("small") < 0){
     52a:	c7 04 24 f5 46 00 00 	movl   $0x46f5,(%esp)
     531:	e8 14 3b 00 00       	call   404a <unlink>
    ...
    exit();
     551:	e8 a4 3a 00 00       	call   3ffa <exit>
    ...
    exit();
     56b:	e8 8a 3a 00 00       	call   3ffa <exit>
  }
...
writetest1(void)
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     5b1:	e8 84 3a 00 00       	call   403a <open>
  ...
  if(fd < 0){
    ...
    exit();
     5d4:	e8 21 3a 00 00       	call   3ffa <exit>
  }
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     602:	e8 13 3a 00 00       	call   401a <write>
     ...
     625:	e8 50 3b 00 00       	call   417a <printf>
      exit();
     62a:	e8 cb 39 00 00       	call   3ffa <exit>
  for(i = 0; i < MAXFILE; i++){
  ...
  if(fd < 0){
    ...
    exit();
     67a:	e8 7b 39 00 00       	call   3ffa <exit>
  }
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     69c:	e8 71 39 00 00       	call   4012 <read>
    ...
    if(i == 0){
     ...
     6ca:	e8 ab 3a 00 00       	call   417a <printf>
        exit();
     6cf:	e8 26 39 00 00       	call   3ffa <exit>
      }
      break;
     6d4:	90                   	nop
             n, ((int*)buf)[0]);
  ...
  close(fd);
     ...
     6db:	e8 42 39 00 00       	call   4022 <close>
  if(unlink("big") < 0){
     6e0:	c7 04 24 2c 48 00 00 	movl   $0x482c,(%esp)
     6e7:	e8 5e 39 00 00       	call   404a <unlink>
     ...
     716:	e8 5f 3a 00 00       	call   417a <printf>
      exit();
     71b:	e8 da 38 00 00       	call   3ffa <exit>
    if(((int*)buf)[0] != n){
     ...
     74e:	e8 27 3a 00 00       	call   417a <printf>
      exit();
     753:	e8 a2 38 00 00       	call   3ffa <exit>
    n++;
    ...
    exit();
     776:	e8 7f 38 00 00       	call   3ffa <exit>
  }
...
createtest(void)
{
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     824:	e8 21 38 00 00       	call   404a <unlink>
  for(i = 0; i < 52; i++){
...
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0){
     ...
     86c:	e8 f1 37 00 00       	call   4062 <mkdir>
    ...
    exit();
     88a:	e8 6b 37 00 00       	call   3ffa <exit>
  }

  if(chdir("dir0") < 0){
     88f:	c7 04 24 4e 49 00 00 	movl   $0x494e,(%esp)
     896:	e8 cf 37 00 00       	call   406a <chdir>
    ...
    exit();
     8b4:	e8 41 37 00 00       	call   3ffa <exit>
  }

  if(chdir("..") < 0){
     8b9:	c7 04 24 66 49 00 00 	movl   $0x4966,(%esp)
     8c0:	e8 a5 37 00 00       	call   406a <chdir>
    ...
    exit();
     8de:	e8 17 37 00 00       	call   3ffa <exit>
  }

  if(unlink("dir0") < 0){
     8e3:	c7 04 24 4e 49 00 00 	movl   $0x494e,(%esp)
     8ea:	e8 5b 37 00 00       	call   404a <unlink>
    ...
    exit();
     908:	e8 ed 36 00 00       	call   3ffa <exit>
  }
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
     ...
     94e:	e8 df 36 00 00       	call   4032 <exec>
    ...
    exit();
     96c:	e8 89 36 00 00       	call   3ffa <exit>
  }
}
     971:	c9                   	leave  
     972:	c3                   	ret    
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
     ...
     97f:	e8 86 36 00 00       	call   400a <pipe>
    ...
    exit();
     99c:	e8 59 36 00 00       	call   3ffa <exit>
  }
  pid = fork();
     9a1:	e8 4c 36 00 00       	call   3ff2 <fork>
  ...
  if(pid == 0){
    ...
    close(fds[0]);
     ...
     9c0:	e8 5d 36 00 00       	call   4022 <close>
    for(n = 0; n < 5; n++){
     ...
     a0e:	e8 07 36 00 00       	call   401a <write>
     ...
     a29:	e8 4c 37 00 00       	call   417a <printf>
        exit();
     a2e:	e8 c7 35 00 00       	call   3ffa <exit>
    for(n = 0; n < 5; n++){
    ...
    exit();
     a3d:	e8 b8 35 00 00       	call   3ffa <exit>
  } else if(pid > 0){
    ...
    close(fds[1]);
     ...
     a52:	e8 cb 35 00 00       	call   4022 <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ae4:	e8 29 35 00 00       	call   4012 <read>
    ...
    if(total != 5 * 1033){
     ...
     b15:	e8 60 36 00 00       	call   417a <printf>
      exit();
     b1a:	e8 db 34 00 00       	call   3ffa <exit>
    }
    close(fds[0]);
     b1f:	8b 45 d8             	mov    -0x28(%ebp),%eax
     b22:	89 04 24             	mov    %eax,(%esp)
     b25:	e8 f8 34 00 00       	call   4022 <close>
    wait();
     b2a:	e8 d3 34 00 00       	call   4002 <wait>
  } else {
  ...
  printf(1, "pipe1 ok\n");
    ...
    exit();
     b59:	e8 9c 34 00 00       	call   3ffa <exit>
}
     b5e:	c9                   	leave  
     b5f:	c3                   	ret    
...
preempt(void)
{
  ...
  pid1 = fork();
     b7a:	e8 73 34 00 00       	call   3ff2 <fork>
  ...
  pid2 = fork();
     b8a:	e8 63 34 00 00       	call   3ff2 <fork>
  ...
  pipe(pfds);
     ...
     ba0:	e8 65 34 00 00       	call   400a <pipe>
  pid3 = fork();
     ba5:	e8 48 34 00 00       	call   3ff2 <fork>
  ...
  if(pid3 == 0){
    ...
    close(pfds[0]);
     ...
     bb9:	e8 64 34 00 00       	call   4022 <close>
    if(write(pfds[1], "x", 1) != 1)
     ...
     bd4:	e8 41 34 00 00       	call   401a <write>
    ...
    close(pfds[1]);
     ...
     bf8:	e8 25 34 00 00       	call   4022 <close>
    for(;;)
      ;
  ...
  close(pfds[1]);
     ...
     c05:	e8 18 34 00 00       	call   4022 <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c20:	e8 ed 33 00 00       	call   4012 <read>
  ...
  close(pfds[0]);
     ...
     c46:	e8 d7 33 00 00       	call   4022 <close>
  printf(1, "kill... ");
  ...
  wait();
     c94:	e8 69 33 00 00       	call   4002 <wait>
  wait();
     c99:	e8 64 33 00 00       	call   4002 <wait>
  wait();
     c9e:	e8 5f 33 00 00       	call   4002 <wait>
  printf(1, "preempt ok\n");
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     cc8:	e8 25 33 00 00       	call   3ff2 <fork>
    ...
    if(pid){
     ...
     d10:	eb 23                	jmp    d35 <exitwait+0x7c>
      ...
      exit();
     d12:	e8 e3 32 00 00       	call   3ffa <exit>
  for(i = 0; i < 100; i++){
...
mem(void)
{
  ...
  ppid = getpid();
     d51:	e8 24 33 00 00       	call   407a <getpid>
     d56:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if((pid = fork()) == 0){
     d59:	e8 94 32 00 00       	call   3ff2 <fork>
    ...
    if(m1 == 0){
     ...
     de7:	e8 3e 32 00 00       	call   402a <kill>
      exit();
     dec:	e8 09 32 00 00       	call   3ffa <exit>
    }
    free(m1);
    ...
    exit();
     e10:	e8 e5 31 00 00       	call   3ffa <exit>
  } else {
    wait();
     e15:	e8 e8 31 00 00       	call   4002 <wait>
  }
}
     e1a:	c9                   	leave  
     e1b:	c3                   	ret    
...
sharedfd(void)
{
  ...
  pid = fork();
     e78:	e8 75 31 00 00       	call   3ff2 <fork>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ec7:	e8 4e 31 00 00       	call   401a <write>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     fa4:	e8 69 30 00 00       	call   4012 <read>
  ...
  close(fd);
     ...
     fb8:	e8 65 30 00 00       	call   4022 <close>
  unlink("sharedfd");
     fbd:	c7 04 24 be 4a 00 00 	movl   $0x4abe,(%esp)
     fc4:	e8 81 30 00 00       	call   404a <unlink>
  if(nc == 10000 && np == 10000){
    ...
    exit();
    1013:	e8 e2 2f 00 00       	call   3ffa <exit>
  }
}
    1018:	c9                   	leave  
    1019:	c3                   	ret    
...
fourfiles(void)
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    106c:	e8 d9 2f 00 00       	call   404a <unlink>

    pid = fork();
    1071:	e8 7c 2f 00 00       	call   3ff2 <fork>
    ...
    108e:	e8 e7 30 00 00       	call   417a <printf>
      exit();
    1093:	e8 62 2f 00 00       	call   3ffa <exit>
    }
    ...
    10b0:	e8 85 2f 00 00       	call   403a <open>
    ...
    10cd:	e8 a8 30 00 00       	call   417a <printf>
        exit();
    10d2:	e8 23 2f 00 00       	call   3ffa <exit>
      }
    ...
    1114:	e8 01 2f 00 00       	call   401a <write>
    ...
    113b:	e8 3a 30 00 00       	call   417a <printf>
          exit();
    1140:	e8 b5 2e 00 00       	call   3ffa <exit>
      for(i = 0; i < 12; i++){
    ...
    114d:	7e af                	jle    10fe <fourfiles+0xe4>
      ...
      exit();
    114f:	e8 a6 2e 00 00       	call   3ffa <exit>
  for(pi = 0; pi < 4; pi++){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    116b:	e8 92 2e 00 00       	call   4002 <wait>
  for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < 2; i++){
    ...
    119e:	e8 97 2e 00 00       	call   403a <open>
    ...
    11df:	e8 96 2f 00 00       	call   417a <printf>
          exit();
    11e4:	e8 11 2e 00 00       	call   3ffa <exit>
      for(j = 0; j < n; j++){
    ...
    1211:	e8 fc 2d 00 00       	call   4012 <read>
    ...
    1225:	e8 f8 2d 00 00       	call   4022 <close>
    if(total != 12*500){
    ...
    1249:	e8 2c 2f 00 00       	call   417a <printf>
      exit();
    124e:	e8 a7 2d 00 00       	call   3ffa <exit>
    }
    unlink(fname);
    1253:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1256:	89 04 24             	mov    %eax,(%esp)
    1259:	e8 ec 2d 00 00       	call   404a <unlink>
  for(i = 0; i < 2; i++){
...
createdelete(void)
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    pid = fork();
    12a8:	e8 45 2d 00 00       	call   3ff2 <fork>
    ...
    12c5:	e8 b0 2e 00 00       	call   417a <printf>
      exit();
    12ca:	e8 2b 2d 00 00       	call   3ffa <exit>
    }
    ...
    1309:	e8 2c 2d 00 00       	call   403a <open>
    ...
    1326:	e8 4f 2e 00 00       	call   417a <printf>
          exit();
    132b:	e8 ca 2c 00 00       	call   3ffa <exit>
        }
        close(fd);
    1330:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1333:	89 04 24             	mov    %eax,(%esp)
    1336:	e8 e7 2c 00 00       	call   4022 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    1363:	e8 e2 2c 00 00       	call   404a <unlink>
    ...
    137b:	e8 fa 2d 00 00       	call   417a <printf>
            exit();
    1380:	e8 75 2c 00 00       	call   3ffa <exit>
      for(i = 0; i < N; i++){
    ...
    138d:	0f 8e 5f ff ff ff    	jle    12f2 <createdelete+0x70>
      ...
      exit();
    1393:	e8 62 2c 00 00       	call   3ffa <exit>
  for(pi = 0; pi < 4; pi++){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    13af:	e8 4e 2c 00 00       	call   4002 <wait>
  for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < N; i++){
    ...
    1408:	e8 2d 2c 00 00       	call   403a <open>
    ...
    1438:	e8 3d 2d 00 00       	call   417a <printf>
        exit();
    143d:	e8 b8 2b 00 00       	call   3ffa <exit>
    ...
    146a:	e8 0b 2d 00 00       	call   417a <printf>
        exit();
    146f:	e8 86 2b 00 00       	call   3ffa <exit>
      }
      if(fd >= 0)
    ...
    1480:	e8 9d 2b 00 00       	call   4022 <close>
    for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < N; i++){
    ...
    14cb:	e8 7a 2b 00 00       	call   404a <unlink>
    for(pi = 0; pi < 4; pi++){
...
unlinkread(void)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1523:	e8 12 2b 00 00       	call   403a <open>
  ...
  if(fd < 0){
    ...
    exit();
    1545:	e8 b0 2a 00 00       	call   3ffa <exit>
  }
  write(fd, "hello", 5);
  ...
  if(fd < 0){
    ...
    exit();
    15a1:	e8 54 2a 00 00       	call   3ffa <exit>
  }
  if(unlink("unlinkread") != 0){
    15a6:	c7 04 24 42 4c 00 00 	movl   $0x4c42,(%esp)
    15ad:	e8 98 2a 00 00       	call   404a <unlink>
    ...
    exit();
    15ca:	e8 2b 2a 00 00       	call   3ffa <exit>
  }
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    15de:	e8 57 2a 00 00       	call   403a <open>
  ...
  write(fd1, "yyy", 3);
    ...
    15fc:	e8 19 2a 00 00       	call   401a <write>
  close(fd1);
    1601:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1604:	89 04 24             	mov    %eax,(%esp)
    1607:	e8 16 2a 00 00       	call   4022 <close>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1622:	e8 eb 29 00 00       	call   4012 <read>
    ...
    exit();
    1640:	e8 b5 29 00 00       	call   3ffa <exit>
  }
  if(buf[0] != 'h'){
    ...
    exit();
    1664:	e8 91 29 00 00       	call   3ffa <exit>
  }
  if(write(fd, buf, 10) != 10){
    ...
    167f:	e8 96 29 00 00       	call   401a <write>
    ...
    exit();
    169d:	e8 58 29 00 00       	call   3ffa <exit>
  }
  close(fd);
    16a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
    16a5:	89 04 24             	mov    %eax,(%esp)
    16a8:	e8 75 29 00 00       	call   4022 <close>
  unlink("unlinkread");
    16ad:	c7 04 24 42 4c 00 00 	movl   $0x4c42,(%esp)
    16b4:	e8 91 29 00 00       	call   404a <unlink>
...
linktest(void)
{
  ...
  if(fd < 0){
    ...
    exit();
    1732:	e8 c3 28 00 00       	call   3ffa <exit>
  }
  if(write(fd, "hello", 5) != 5){
    ...
    174d:	e8 c8 28 00 00       	call   401a <write>
  ...
  if(open("lf1", 0) >= 0){
    ...
    exit();
    17e4:	e8 11 28 00 00       	call   3ffa <exit>
  }
  ...
  fd = open("lf2", 0);
    ...
    17f8:	e8 3d 28 00 00       	call   403a <open>
  ...
  if(fd < 0){
    ...
    exit();
    181a:	e8 db 27 00 00       	call   3ffa <exit>
  }
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1835:	e8 d8 27 00 00       	call   4012 <read>
  ...
  if(link("lf2", "lf1") >= 0){
    ...
    exit();
    18cc:	e8 29 27 00 00       	call   3ffa <exit>
  }
  ...
  if(link(".", "lf1") >= 0){
    ...
    18e0:	e8 75 27 00 00       	call   405a <link>
    ...
    exit();
    18fd:	e8 f8 26 00 00       	call   3ffa <exit>
  }
...
concreate(void)
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1955:	e8 f0 26 00 00       	call   404a <unlink>
    pid = fork();
    195a:	e8 93 26 00 00       	call   3ff2 <fork>
    ...
    1998:	e8 bd 26 00 00       	call   405a <link>
    ...
    19db:	e8 7a 26 00 00       	call   405a <link>
    ...
    19f0:	e8 45 26 00 00       	call   403a <open>
    ...
    1a14:	e8 61 27 00 00       	call   417a <printf>
        exit();
    1a19:	e8 dc 25 00 00       	call   3ffa <exit>
      }
      close(fd);
    1a1e:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1a21:	89 04 24             	mov    %eax,(%esp)
    1a24:	e8 f9 25 00 00       	call   4022 <close>
    }
    if(pid == 0)
    1a29:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1a2d:	75 05                	jne    1a34 <concreate+0x11c>
      exit();
    1a2f:	e8 c6 25 00 00       	call   3ffa <exit>
    else
      wait();
    1a34:	e8 c9 25 00 00       	call   4002 <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    1a71:	e8 c4 25 00 00       	call   403a <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1adb:	e8 9a 26 00 00       	call   417a <printf>
        exit();
    1ae0:	e8 15 25 00 00       	call   3ffa <exit>
      }
      if(fa[i]){
    ...
    1b0d:	e8 68 26 00 00       	call   417a <printf>
        exit();
    1b12:	e8 e3 24 00 00       	call   3ffa <exit>
      }
      fa[i] = 1;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1b3b:	e8 d2 24 00 00       	call   4012 <read>
  ...
  close(fd);
    ...
    1b4e:	e8 cf 24 00 00       	call   4022 <close>
  ...
  if(n != 40){
    ...
    exit();
    1b6d:	e8 88 24 00 00       	call   3ffa <exit>
  }
  ...
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    1b87:	e8 66 24 00 00       	call   3ff2 <fork>
    ...
    1ba4:	e8 d1 25 00 00       	call   417a <printf>
      exit();
    1ba9:	e8 4c 24 00 00       	call   3ffa <exit>
    }
    if(((i % 3) == 0 && pid == 0) ||
...
linkunlink()
{
  ...
  unlink("x");
    ...
    1cec:	e8 59 23 00 00       	call   404a <unlink>
  pid = fork();
    1cf1:	e8 fc 22 00 00       	call   3ff2 <fork>
  ...
  if(pid < 0){
    ...
    exit();
    1d13:	e8 e2 22 00 00       	call   3ffa <exit>
  }
  ...
  for(i = 0; i < 100; i++){
    ...
    1d75:	e8 c0 22 00 00       	call   403a <open>
    1d7a:	89 04 24             	mov    %eax,(%esp)
    1d7d:	e8 a0 22 00 00       	call   4022 <close>
  ...
  if(pid)
    ...
    wait();
    1dd7:	e8 26 22 00 00       	call   4002 <wait>
    1ddc:	eb 05                	jmp    1de3 <linkunlink+0x118>
  else
    exit();
    1dde:	e8 17 22 00 00       	call   3ffa <exit>
...
bigdir(void)
{
  ...
  if(fd < 0){
    ...
    exit();
    1e50:	e8 a5 21 00 00       	call   3ffa <exit>
  }
  close(fd);
    1e55:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1e58:	89 04 24             	mov    %eax,(%esp)
    1e5b:	e8 c2 21 00 00       	call   4022 <close>
  ...
  for(i = 0; i < 500; i++){
    ...
    1ea7:	e8 ae 21 00 00       	call   405a <link>
    ...
    1ebf:	e8 b6 22 00 00       	call   417a <printf>
      exit();
    1ec4:	e8 31 21 00 00       	call   3ffa <exit>
  for(i = 0; i < 500; i++){
  ...
  unlink("bd");
    ...
    1edd:	e8 68 21 00 00       	call   404a <unlink>
  for(i = 0; i < 500; i++){
    ...
    1f21:	e8 24 21 00 00       	call   404a <unlink>
    ...
    1f39:	e8 3c 22 00 00       	call   417a <printf>
      exit();
    1f3e:	e8 b7 20 00 00       	call   3ffa <exit>
  for(i = 0; i < 500; i++){
...
subdir(void)
{
  ...
  unlink("ff");
    ...
    1f87:	e8 be 20 00 00       	call   404a <unlink>
  if(mkdir("dd") != 0){
    1f8c:	c7 04 24 31 4f 00 00 	movl   $0x4f31,(%esp)
    1f93:	e8 ca 20 00 00       	call   4062 <mkdir>
    ...
    exit();
    1fb0:	e8 45 20 00 00       	call   3ffa <exit>
  }
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fc4:	e8 71 20 00 00       	call   403a <open>
  ...
  if(fd < 0){
    ...
    exit();
    1fe6:	e8 0f 20 00 00       	call   3ffa <exit>
  }
  write(fd, "ff", 2);
    ...
    2001:	e8 14 20 00 00       	call   401a <write>
  close(fd);
    2006:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2009:	89 04 24             	mov    %eax,(%esp)
    200c:	e8 11 20 00 00       	call   4022 <close>

  if(unlink("dd") >= 0){
    2011:	c7 04 24 31 4f 00 00 	movl   $0x4f31,(%esp)
    2018:	e8 2d 20 00 00       	call   404a <unlink>
    ...
    exit();
    2035:	e8 c0 1f 00 00       	call   3ffa <exit>
  }

  if(mkdir("/dd/dd") != 0){
    203a:	c7 04 24 8e 4f 00 00 	movl   $0x4f8e,(%esp)
    2041:	e8 1c 20 00 00       	call   4062 <mkdir>
    ...
    exit();
    205e:	e8 97 1f 00 00       	call   3ffa <exit>
  }
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2072:	e8 c3 1f 00 00       	call   403a <open>
  ...
  if(fd < 0){
    ...
    exit();
    2094:	e8 61 1f 00 00       	call   3ffa <exit>
  }
  write(fd, "FF", 2);
  ...
  if(fd < 0){
    ...
    exit();
    20f0:	e8 05 1f 00 00       	call   3ffa <exit>
  }
  cc = read(fd, buf, sizeof(buf));
    ...
    210b:	e8 02 1f 00 00       	call   4012 <read>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    exit();
    2174:	e8 81 1e 00 00       	call   3ffa <exit>
  }

  if(unlink("dd/dd/ff") != 0){
    2179:	c7 04 24 b0 4f 00 00 	movl   $0x4fb0,(%esp)
    2180:	e8 c5 1e 00 00       	call   404a <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    exit();
    21ce:	e8 27 1e 00 00       	call   3ffa <exit>
  }

  if(chdir("dd") != 0){
    21d3:	c7 04 24 31 4f 00 00 	movl   $0x4f31,(%esp)
    21da:	e8 8b 1e 00 00       	call   406a <chdir>
    ...
    exit();
    21f7:	e8 fe 1d 00 00       	call   3ffa <exit>
  }
  if(chdir("dd/../../dd") != 0){
    21fc:	c7 04 24 91 50 00 00 	movl   $0x5091,(%esp)
    2203:	e8 62 1e 00 00       	call   406a <chdir>
    ...
    exit();
    2220:	e8 d5 1d 00 00       	call   3ffa <exit>
  }
  if(chdir("dd/../../../dd") != 0){
    2225:	c7 04 24 b7 50 00 00 	movl   $0x50b7,(%esp)
    222c:	e8 39 1e 00 00       	call   406a <chdir>
    ...
    exit();
    2249:	e8 ac 1d 00 00       	call   3ffa <exit>
  }
  if(chdir("./..") != 0){
    224e:	c7 04 24 c6 50 00 00 	movl   $0x50c6,(%esp)
    2255:	e8 10 1e 00 00       	call   406a <chdir>
    ...
    exit();
    2272:	e8 83 1d 00 00       	call   3ffa <exit>
  }
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    2286:	e8 af 1d 00 00       	call   403a <open>
  ...
  if(fd < 0){
    ...
    exit();
    22a8:	e8 4d 1d 00 00       	call   3ffa <exit>
  }
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22c3:	e8 4a 1d 00 00       	call   4012 <read>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    exit();
    231d:	e8 d8 1c 00 00       	call   3ffa <exit>
  }
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2331:	e8 04 1d 00 00       	call   403a <open>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    exit();
    24a5:	e8 50 1b 00 00       	call   3ffa <exit>
  }
  if(mkdir("dd/ff/ff") == 0){
    24aa:	c7 04 24 39 51 00 00 	movl   $0x5139,(%esp)
    24b1:	e8 ac 1b 00 00       	call   4062 <mkdir>
    ...
    exit();
    24ce:	e8 27 1b 00 00       	call   3ffa <exit>
  }
  if(mkdir("dd/xx/ff") == 0){
    24d3:	c7 04 24 5e 51 00 00 	movl   $0x515e,(%esp)
    24da:	e8 83 1b 00 00       	call   4062 <mkdir>
    ...
    exit();
    24f7:	e8 fe 1a 00 00       	call   3ffa <exit>
  }
  if(mkdir("dd/dd/ffff") == 0){
    24fc:	c7 04 24 14 50 00 00 	movl   $0x5014,(%esp)
    2503:	e8 5a 1b 00 00       	call   4062 <mkdir>
    ...
    exit();
    2520:	e8 d5 1a 00 00       	call   3ffa <exit>
  }
  if(unlink("dd/xx/ff") == 0){
    2525:	c7 04 24 5e 51 00 00 	movl   $0x515e,(%esp)
    252c:	e8 19 1b 00 00       	call   404a <unlink>
    ...
    exit();
    2549:	e8 ac 1a 00 00       	call   3ffa <exit>
  }
  if(unlink("dd/ff/ff") == 0){
    254e:	c7 04 24 39 51 00 00 	movl   $0x5139,(%esp)
    2555:	e8 f0 1a 00 00       	call   404a <unlink>
    ...
    exit();
    2572:	e8 83 1a 00 00       	call   3ffa <exit>
  }
  if(chdir("dd/ff") == 0){
    2577:	c7 04 24 4c 4f 00 00 	movl   $0x4f4c,(%esp)
    257e:	e8 e7 1a 00 00       	call   406a <chdir>
    ...
    exit();
    259b:	e8 5a 1a 00 00       	call   3ffa <exit>
  }
  if(chdir("dd/xx") == 0){
    25a0:	c7 04 24 e5 52 00 00 	movl   $0x52e5,(%esp)
    25a7:	e8 be 1a 00 00       	call   406a <chdir>
    ...
    exit();
    25c4:	e8 31 1a 00 00       	call   3ffa <exit>
  }

  if(unlink("dd/dd/ffff") != 0){
    25c9:	c7 04 24 14 50 00 00 	movl   $0x5014,(%esp)
    25d0:	e8 75 1a 00 00       	call   404a <unlink>
    ...
    exit();
    25ed:	e8 08 1a 00 00       	call   3ffa <exit>
  }
  if(unlink("dd/ff") != 0){
    25f2:	c7 04 24 4c 4f 00 00 	movl   $0x4f4c,(%esp)
    25f9:	e8 4c 1a 00 00       	call   404a <unlink>
    ...
    exit();
    2616:	e8 df 19 00 00       	call   3ffa <exit>
  }
  if(unlink("dd") == 0){
    261b:	c7 04 24 31 4f 00 00 	movl   $0x4f31,(%esp)
    2622:	e8 23 1a 00 00       	call   404a <unlink>
    ...
    exit();
    263f:	e8 b6 19 00 00       	call   3ffa <exit>
  }
  if(unlink("dd/dd") < 0){
    2644:	c7 04 24 38 53 00 00 	movl   $0x5338,(%esp)
    264b:	e8 fa 19 00 00       	call   404a <unlink>
    ...
    exit();
    2668:	e8 8d 19 00 00       	call   3ffa <exit>
  }
  if(unlink("dd") < 0){
    266d:	c7 04 24 31 4f 00 00 	movl   $0x4f31,(%esp)
    2674:	e8 d1 19 00 00       	call   404a <unlink>
    ...
    exit();
    2691:	e8 64 19 00 00       	call   3ffa <exit>
  }
...
bigwrite(void)
{
  ...
  unlink("bigwrite");
    ...
    26cd:	e8 78 19 00 00       	call   404a <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26ed:	e8 48 19 00 00       	call   403a <open>
    ...
    270a:	e8 6b 1a 00 00       	call   417a <printf>
      exit();
    270f:	e8 e6 18 00 00       	call   3ffa <exit>
    }
    int i;
    for(i = 0; i < 2; i++){
    ...
    2732:	e8 e3 18 00 00       	call   401a <write>
    ...
    275f:	e8 16 1a 00 00       	call   417a <printf>
        exit();
    2764:	e8 91 18 00 00       	call   3ffa <exit>
    for(i = 0; i < 2; i++){
    ...
    2779:	e8 a4 18 00 00       	call   4022 <close>
    unlink("bigwrite");
    277e:	c7 04 24 7f 53 00 00 	movl   $0x537f,(%esp)
    2785:	e8 c0 18 00 00       	call   404a <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
...
bigfile(void)
{
  ...
  if(fd < 0){
    ...
    exit();
    280b:	e8 ea 17 00 00       	call   3ffa <exit>
  }
  for(i = 0; i < 20; i++){
    ...
    284a:	e8 cb 17 00 00       	call   401a <write>
    ...
    2865:	e8 10 19 00 00       	call   417a <printf>
      exit();
    286a:	e8 8b 17 00 00       	call   3ffa <exit>
  for(i = 0; i < 20; i++){
  ...
  if(fd < 0){
    ...
    exit();
    28b5:	e8 40 17 00 00       	call   3ffa <exit>
  }
  total = 0;
  ...
  for(i = 0; ; i++){
    ...
    28de:	e8 2f 17 00 00       	call   4012 <read>
    ...
    28fb:	e8 7a 18 00 00       	call   417a <printf>
      exit();
    2900:	e8 f5 16 00 00       	call   3ffa <exit>
    }
    if(cc == 0)
  ...
  close(fd);
    ...
    2912:	e8 0b 17 00 00       	call   4022 <close>
  if(total != 20*600){
    ...
    293e:	e8 37 18 00 00       	call   417a <printf>
      exit();
    2943:	e8 b2 16 00 00       	call   3ffa <exit>
    ...
    298b:	e8 ea 17 00 00       	call   417a <printf>
      exit();
    2990:	e8 65 16 00 00       	call   3ffa <exit>
    total += cc;
  ...
  for(i = 0; ; i++){
    ...
    exit();
    29b8:	e8 3d 16 00 00       	call   3ffa <exit>
  }
  unlink("bigfile");
    29bd:	c7 04 24 cd 53 00 00 	movl   $0x53cd,(%esp)
    29c4:	e8 81 16 00 00       	call   404a <unlink>
...
fourteen(void)
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2a00:	e8 5d 16 00 00       	call   4062 <mkdir>
    ...
    exit();
    2a1d:	e8 d8 15 00 00       	call   3ffa <exit>
  }
  if(mkdir("12345678901234/123456789012345") != 0){
    2a22:	c7 04 24 c0 54 00 00 	movl   $0x54c0,(%esp)
    2a29:	e8 34 16 00 00       	call   4062 <mkdir>
  ...
  if(fd < 0){
    ...
    exit();
    2abd:	e8 38 15 00 00       	call   3ffa <exit>
  }
  close(fd);
    2ac2:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2ac5:	89 04 24             	mov    %eax,(%esp)
    2ac8:	e8 55 15 00 00       	call   4022 <close>

  if(mkdir("12345678901234/12345678901234") == 0){
    2acd:	c7 04 24 ea 55 00 00 	movl   $0x55ea,(%esp)
    2ad4:	e8 89 15 00 00       	call   4062 <mkdir>
    ...
    exit();
    2af1:	e8 04 15 00 00       	call   3ffa <exit>
  }
  if(mkdir("123456789012345/12345678901234") == 0){
    2af6:	c7 04 24 38 56 00 00 	movl   $0x5638,(%esp)
    2afd:	e8 60 15 00 00       	call   4062 <mkdir>
    ...
    exit();
    2b1a:	e8 db 14 00 00       	call   3ffa <exit>
  }
...
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    ...
    2b56:	e8 07 15 00 00       	call   4062 <mkdir>
    ...
    exit();
    2b73:	e8 82 14 00 00       	call   3ffa <exit>
  }
  if(chdir("dots") != 0){
    2b78:	c7 04 24 a2 56 00 00 	movl   $0x56a2,(%esp)
    2b7f:	e8 e6 14 00 00       	call   406a <chdir>
    ...
    exit();
    2b9c:	e8 59 14 00 00       	call   3ffa <exit>
  }
  if(unlink(".") == 0){
    2ba1:	c7 04 24 d3 4d 00 00 	movl   $0x4dd3,(%esp)
    2ba8:	e8 9d 14 00 00       	call   404a <unlink>
    ...
    exit();
    2bc5:	e8 30 14 00 00       	call   3ffa <exit>
  }
  if(unlink("..") == 0){
    2bca:	c7 04 24 66 49 00 00 	movl   $0x4966,(%esp)
    2bd1:	e8 74 14 00 00       	call   404a <unlink>
    ...
    exit();
    2bee:	e8 07 14 00 00       	call   3ffa <exit>
  }
  if(chdir("/") != 0){
    2bf3:	c7 04 24 ba 45 00 00 	movl   $0x45ba,(%esp)
    2bfa:	e8 6b 14 00 00       	call   406a <chdir>
    ...
    exit();
    2c17:	e8 de 13 00 00       	call   3ffa <exit>
  }
  if(unlink("dots/.") == 0){
    2c1c:	c7 04 24 ea 56 00 00 	movl   $0x56ea,(%esp)
    2c23:	e8 22 14 00 00       	call   404a <unlink>
    ...
    exit();
    2c40:	e8 b5 13 00 00       	call   3ffa <exit>
  }
  if(unlink("dots/..") == 0){
    2c45:	c7 04 24 08 57 00 00 	movl   $0x5708,(%esp)
    2c4c:	e8 f9 13 00 00       	call   404a <unlink>
    ...
    exit();
    2c69:	e8 8c 13 00 00       	call   3ffa <exit>
  }
  if(unlink("dots") != 0){
    2c6e:	c7 04 24 a2 56 00 00 	movl   $0x56a2,(%esp)
    2c75:	e8 d0 13 00 00       	call   404a <unlink>
    ...
    exit();
    2c92:	e8 63 13 00 00       	call   3ffa <exit>
  }
  printf(1, "rmdot ok\n");
...
dirfile(void)
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2cd6:	e8 5f 13 00 00       	call   403a <open>
  ...
  if(fd < 0){
    ...
    exit();
    2cf8:	e8 fd 12 00 00       	call   3ffa <exit>
  }
  close(fd);
    2cfd:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2d00:	89 04 24             	mov    %eax,(%esp)
    2d03:	e8 1a 13 00 00       	call   4022 <close>
  if(chdir("dirfile") == 0){
    2d08:	c7 04 24 54 57 00 00 	movl   $0x5754,(%esp)
    2d0f:	e8 56 13 00 00       	call   406a <chdir>
  ...
  if(fd >= 0){
    ...
    exit();
    2d98:	e8 5d 12 00 00       	call   3ffa <exit>
  }
  if(mkdir("dirfile/xx") == 0){
    2d9d:	c7 04 24 8d 57 00 00 	movl   $0x578d,(%esp)
    2da4:	e8 b9 12 00 00       	call   4062 <mkdir>
    ...
    exit();
    2dc1:	e8 34 12 00 00       	call   3ffa <exit>
  }
  if(unlink("dirfile/xx") == 0){
    2dc6:	c7 04 24 8d 57 00 00 	movl   $0x578d,(%esp)
    2dcd:	e8 78 12 00 00       	call   404a <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    exit();
    2e1b:	e8 da 11 00 00       	call   3ffa <exit>
  }
  if(unlink("dirfile") != 0){
    2e20:	c7 04 24 54 57 00 00 	movl   $0x5754,(%esp)
    2e27:	e8 1e 12 00 00       	call   404a <unlink>
    ...
    exit();
    2e44:	e8 b1 11 00 00       	call   3ffa <exit>
  }
  ...
  fd = open(".", O_RDWR);
    ...
    2e58:	e8 dd 11 00 00       	call   403a <open>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2eac:	e8 69 11 00 00       	call   401a <write>
    ...
    exit();
    2ec9:	e8 2c 11 00 00       	call   3ffa <exit>
  }
  close(fd);
    2ece:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2ed1:	89 04 24             	mov    %eax,(%esp)
    2ed4:	e8 49 11 00 00       	call   4022 <close>
...
iref(void)
{
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2f1c:	e8 41 11 00 00       	call   4062 <mkdir>
    ...
    2f34:	e8 41 12 00 00       	call   417a <printf>
      exit();
    2f39:	e8 bc 10 00 00       	call   3ffa <exit>
    }
    if(chdir("irefd") != 0){
    2f3e:	c7 04 24 84 58 00 00 	movl   $0x5884,(%esp)
    2f45:	e8 20 11 00 00       	call   406a <chdir>
    ...
    2fd2:	e8 4b 10 00 00       	call   4022 <close>
    unlink("xx");
    2fd7:	c7 04 24 b3 58 00 00 	movl   $0x58b3,(%esp)
    2fde:	e8 67 10 00 00       	call   404a <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2ff8:	e8 6d 10 00 00       	call   406a <chdir>
...
forktest(void)
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    3036:	e8 b7 0f 00 00       	call   3ff2 <fork>
    ...
    304a:	75 05                	jne    3051 <forktest+0x3e>
      exit();
    304c:	e8 a9 0f 00 00       	call   3ffa <exit>
  for(n=0; n<1000; n++){
  ...
  if(n == 1000){
    ...
    exit();
    307b:	e8 7a 0f 00 00       	call   3ffa <exit>
  }

  for(; n > 0; n--){
    3080:	eb 26                	jmp    30a8 <forktest+0x95>
    if(wait() < 0){
    3082:	e8 7b 0f 00 00       	call   4002 <wait>
    ...
    309a:	e8 db 10 00 00       	call   417a <printf>
      exit();
    309f:	e8 56 0f 00 00       	call   3ffa <exit>
  for(; n > 0; n--){
  ...
  if(wait() != -1){
    30ae:	e8 4f 0f 00 00       	call   4002 <wait>
    ...
    exit();
    30cc:	e8 29 0f 00 00       	call   3ffa <exit>
  }
...
sbrktest(void)
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    3134:	e8 49 0f 00 00       	call   4082 <sbrk>
    ...
    3169:	e8 0c 10 00 00       	call   417a <printf>
      exit();
    316e:	e8 87 0e 00 00       	call   3ffa <exit>
    }
    *b = 1;
  ...
  pid = fork();
    318f:	e8 5e 0e 00 00       	call   3ff2 <fork>
  ...
  if(c != a + 1){
    ...
    exit();
    31f5:	e8 00 0e 00 00       	call   3ffa <exit>
  }
  if(pid == 0)
    31fa:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
    31fe:	75 05                	jne    3205 <sbrktest+0x11e>
    exit();
    3200:	e8 f5 0d 00 00       	call   3ffa <exit>
  wait();
    3205:	e8 f8 0d 00 00       	call   4002 <wait>

  // can one grow address space to something big?
#define BIG (100*1024*1024)
  a = sbrk(0);
    320a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3211:	e8 6c 0e 00 00       	call   4082 <sbrk>
  ...
  p = sbrk(amt);
    ...
    322e:	e8 4f 0e 00 00       	call   4082 <sbrk>
  ...
  if (p != a) {
    ...
    exit();
    3253:	e8 a2 0d 00 00       	call   3ffa <exit>
  }
  lastaddr = (char*) (BIG-1);
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    exit();
    329e:	e8 57 0d 00 00       	call   3ffa <exit>
  }
  c = sbrk(0);
    32a3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    32aa:	e8 d3 0d 00 00       	call   4082 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3314:	e8 69 0d 00 00       	call   4082 <sbrk>
    ...
    exit();
    3349:	e8 ac 0c 00 00       	call   3ffa <exit>
  }
  if(*lastaddr == 99){
  ...
  if(c != a){
    ...
    exit();
    33ca:	e8 2b 0c 00 00       	call   3ffa <exit>
  }
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    33d8:	e8 9d 0c 00 00       	call   407a <getpid>
    33dd:	89 45 d0             	mov    %eax,-0x30(%ebp)
    pid = fork();
    33e0:	e8 0d 0c 00 00       	call   3ff2 <fork>
    ...
    33fe:	e8 77 0d 00 00       	call   417a <printf>
      exit();
    3403:	e8 f2 0b 00 00       	call   3ffa <exit>
    }
    if(pid == 0){
    ...
    343d:	e8 e8 0b 00 00       	call   402a <kill>
      exit();
    3442:	e8 b3 0b 00 00       	call   3ffa <exit>
    }
    wait();
    3447:	e8 b6 0b 00 00       	call   4002 <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    3466:	e8 9f 0b 00 00       	call   400a <pipe>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34de:	e8 37 0b 00 00       	call   401a <write>
      // sit around until killed
      for(;;) sleep(1000);
    34e3:	c7 04 24 e8 03 00 00 	movl   $0x3e8,(%esp)
    34ea:	e8 9b 0b 00 00       	call   408a <sleep>
    ...
    3512:	e8 fb 0a 00 00       	call   4012 <read>
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
  ...
  c = sbrk(4096);
    ...
    352e:	e8 4f 0b 00 00       	call   4082 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3557:	e8 ce 0a 00 00       	call   402a <kill>
    wait();
    355c:	e8 a1 0a 00 00       	call   4002 <wait>
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
  ...
  if(c == (char*)0xffffffff){
    ...
    exit();
    3588:	e8 6d 0a 00 00       	call   3ffa <exit>
  }

  if(sbrk(0) > oldbrk)
    358d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3594:	e8 e9 0a 00 00       	call   4082 <sbrk>
...
validatetest(void)
{
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    if((pid = fork()) == 0){
    3624:	e8 c9 09 00 00       	call   3ff2 <fork>
    ...
    3638:	e8 9a ff ff ff       	call   35d7 <validateint>
      exit();
    363d:	e8 b8 09 00 00       	call   3ffa <exit>
    }
    sleep(0);
    3642:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3649:	e8 3c 0a 00 00       	call   408a <sleep>
    sleep(0);
    364e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3655:	e8 30 0a 00 00       	call   408a <sleep>
    kill(pid);
    365a:	8b 45 ec             	mov    -0x14(%ebp),%eax
    365d:	89 04 24             	mov    %eax,(%esp)
    3660:	e8 c5 09 00 00       	call   402a <kill>
    wait();
    3665:	e8 98 09 00 00       	call   4002 <wait>
    ...
    3678:	e8 dd 09 00 00       	call   405a <link>
    ...
    3692:	e8 e3 0a 00 00       	call   417a <printf>
      exit();
    3697:	e8 5e 09 00 00       	call   3ffa <exit>
  for(p = 0; p <= (uint)hi; p += 4096){
...
bsstest(void)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3709:	e8 6c 0a 00 00       	call   417a <printf>
      exit();
    370e:	e8 e7 08 00 00       	call   3ffa <exit>
  for(i = 0; i < sizeof(uninit); i++){
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    ...
    3745:	e8 00 09 00 00       	call   404a <unlink>
  pid = fork();
    374a:	e8 a3 08 00 00       	call   3ff2 <fork>
  ...
  if(pid == 0){
    ...
    37ab:	e8 82 08 00 00       	call   4032 <exec>
    ...
    37d4:	e8 61 08 00 00       	call   403a <open>
    37d9:	89 45 ec             	mov    %eax,-0x14(%ebp)
    close(fd);
    37dc:	8b 45 ec             	mov    -0x14(%ebp),%eax
    37df:	89 04 24             	mov    %eax,(%esp)
    37e2:	e8 3b 08 00 00       	call   4022 <close>
    exit();
    37e7:	e8 0e 08 00 00       	call   3ffa <exit>
  } else if(pid < 0){
    ...
    exit();
    3807:	e8 ee 07 00 00       	call   3ffa <exit>
  }
  wait();
    380c:	e8 f1 07 00 00       	call   4002 <wait>
  fd = open("bigarg-ok", 0);
    3811:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    3818:	00 
    3819:	c7 04 24 3f 5b 00 00 	movl   $0x5b3f,(%esp)
    3820:	e8 15 08 00 00       	call   403a <open>
  ...
  if(fd < 0){
    ...
    exit();
    3843:	e8 b2 07 00 00       	call   3ffa <exit>
  }
  close(fd);
    3848:	8b 45 ec             	mov    -0x14(%ebp),%eax
    384b:	89 04 24             	mov    %eax,(%esp)
    384e:	e8 cf 07 00 00       	call   4022 <close>
  unlink("bigarg-ok");
    3853:	c7 04 24 3f 5b 00 00 	movl   $0x5b3f,(%esp)
    385a:	e8 eb 07 00 00       	call   404a <unlink>
}
    385f:	c9                   	leave  
    3860:	c3                   	ret    
...
fsfull()
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    397b:	e8 ba 06 00 00       	call   403a <open>
    ...
    39c3:	e8 52 06 00 00       	call   401a <write>
    ...
    39f6:	e8 27 06 00 00       	call   4022 <close>
    if(total == 0)
  ...
  while(nfiles >= 0){
    ...
    3aed:	e8 58 05 00 00       	call   404a <unlink>
    nfiles--;
...
uio()
{
  ...
  pid = fork();
    3b3e:	e8 af 04 00 00       	call   3ff2 <fork>
  ...
  if(pid == 0){
    ...
    exit();
    3b83:	e8 72 04 00 00       	call   3ffa <exit>
  } else if(pid < 0){
    ...
    exit();
    3ba2:	e8 53 04 00 00       	call   3ffa <exit>
  }
  wait();
    3ba7:	e8 56 04 00 00       	call   4002 <wait>
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3bd7:	e8 5e 04 00 00       	call   403a <open>
  ...
  if (fd < 0) {
    ...
    exit();
    3bf9:	e8 fc 03 00 00       	call   3ffa <exit>
  }
  read(fd, sbrk(0) - 1, -1);
    3bfe:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3c05:	e8 78 04 00 00       	call   4082 <sbrk>
    ...
    3c1f:	e8 ee 03 00 00       	call   4012 <read>
  close(fd);
    3c24:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3c27:	89 04 24             	mov    %eax,(%esp)
    3c2a:	e8 f3 03 00 00       	call   4022 <close>
...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    3c90:	e8 a5 03 00 00       	call   403a <open>
  ...
  exit();
    3d7d:	e8 78 02 00 00       	call   3ffa <exit>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    3eb9:	e8 54 01 00 00       	call   4012 <read>
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    3f1e:	e8 17 01 00 00       	call   403a <open>
...
SYSCALL(fkc)
    3fe2:	b8 17 00 00 00       	mov    $0x17,%eax
    3fe7:	cd 40                	int    $0x40
    3fe9:	c3                   	ret    

00003fea <hw>:
SYSCALL(hw)
    3fea:	b8 16 00 00 00       	mov    $0x16,%eax
    3fef:	cd 40                	int    $0x40
    3ff1:	c3                   	ret    
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    40bb:	e8 5a ff ff ff       	call   401a <write>
}
    40c0:	c9                   	leave  
    40c1:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    442d:	e8 50 fc ff ff       	call   4082 <sbrk>
