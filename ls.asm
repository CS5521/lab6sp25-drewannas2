...
ls(char *path)
{
  ...
  ca:	e8 44 05 00 00       	call   613 <open>
 ...
 108:	e8 1e 05 00 00       	call   62b <fstat>
 ...
 132:	e8 c4 04 00 00       	call   5fb <close>
    return;
 ...
 2df:	e8 07 03 00 00       	call   5eb <read>
 ...
 2f4:	e8 02 03 00 00       	call   5fb <close>
}
...
main(int argc, char *argv[])
{
 ...
 31a:	e8 91 fd ff ff       	call   b0 <ls>
    exit();
 31f:	e8 af 02 00 00       	call   5d3 <exit>
  }
  for(i=1; i<argc; i++)
 ...
 354:	7c d8                	jl     32e <main+0x2a>
  exit();
 356:	e8 78 02 00 00       	call   5d3 <exit>
...
gets(char *buf, int max)
{
 ...
 492:	e8 54 01 00 00       	call   5eb <read>
...
stat(const char *n, struct stat *st)
{
 ...
 4f7:	e8 17 01 00 00       	call   613 <open>
...
putc(int fd, char c)
{
 ...
 694:	e8 5a ff ff ff       	call   5f3 <write>
}
 699:	c9                   	leave  
 69a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a06:	e8 50 fc ff ff       	call   65b <sbrk>
