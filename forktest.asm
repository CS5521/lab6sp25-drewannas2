...
printf(int fd, const char *s, ...)
{
  ...
  22:	e8 86 03 00 00       	call   3ad <write>
}
  27:	c9                   	leave  
  28:	c3                   	ret    
...
forktest(void)
{
  ...
  4a:	eb 1f                	jmp    6b <forktest+0x42>
    pid = fork();
  4c:	e8 34 03 00 00       	call   385 <fork>
  ...
  60:	75 05                	jne    67 <forktest+0x3e>
      exit();
  62:	e8 26 03 00 00       	call   38d <exit>
  for(n=0; n<N; n++){
  ...
  94:	e8 67 ff ff ff       	call   0 <printf>
    exit();
  99:	e8 ef 02 00 00       	call   38d <exit>
  }

  for(; n > 0; n--){
  9e:	eb 26                	jmp    c6 <forktest+0x9d>
    if(wait() < 0){
  a0:	e8 f0 02 00 00       	call   395 <wait>
  ...
  b8:	e8 43 ff ff ff       	call   0 <printf>
      exit();
  bd:	e8 cb 02 00 00       	call   38d <exit>
  for(; n > 0; n--){
  ...
  if(wait() != -1){
  cc:	e8 c4 02 00 00       	call   395 <wait>
  ...
  e5:	e8 16 ff ff ff       	call   0 <printf>
    exit();
  ea:	e8 9e 02 00 00       	call   38d <exit>
  }
...
main(void)
{
 ...
 10b:	e8 19 ff ff ff       	call   29 <forktest>
  exit();
 110:	e8 78 02 00 00       	call   38d <exit>
...
gets(char *buf, int max)
{
 ...
 24c:	e8 54 01 00 00       	call   3a5 <read>
...
stat(const char *n, struct stat *st)
{
 ...
 2b1:	e8 17 01 00 00       	call   3cd <open>
