...
main(int argc, char *argv[])
{
  ...
  1e:	e8 4e 04 00 00       	call   471 <printf>
    exit();
  23:	e8 c9 02 00 00       	call   2f1 <exit>
  }
  ...
  3f:	e8 0d 03 00 00       	call   351 <link>
  ...
  exit();
  74:	e8 78 02 00 00       	call   2f1 <exit>
...
gets(char *buf, int max)
{
 ...
 1b0:	e8 54 01 00 00       	call   309 <read>
...
stat(const char *n, struct stat *st)
{
 ...
 215:	e8 17 01 00 00       	call   331 <open>
 ...
 237:	e8 0d 01 00 00       	call   349 <fstat>
 23c:	89 45 f0             	mov    %eax,-0x10(%ebp)
  close(fd);
 23f:	8b 45 f4             	mov    -0xc(%ebp),%eax
 242:	89 04 24             	mov    %eax,(%esp)
 245:	e8 cf 00 00 00       	call   319 <close>
  return r;
...
SYSCALL(fkc)
 2d9:	b8 17 00 00 00       	mov    $0x17,%eax
 2de:	cd 40                	int    $0x40
 2e0:	c3                   	ret    
...
putc(int fd, char c)
{
 ...
 3b2:	e8 5a ff ff ff       	call   311 <write>
}
 3b7:	c9                   	leave  
 3b8:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 724:	e8 50 fc ff ff       	call   379 <sbrk>
