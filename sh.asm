...
runcmd(struct cmd *cmd)
{
  ...
  if(cmd == 0)
    ...
    exit();
       c:	e8 60 0f 00 00       	call   f71 <exit>
  ...
  case EXEC:
    ...
    if(ecmd->argv[0] == 0)
      ...
      exit();
      40:	e8 2c 0f 00 00       	call   f71 <exit>
    exec(ecmd->argv[0], ecmd->argv);
      ...
      58:	e8 4c 0f 00 00       	call   fa9 <exec>
  ...
  case REDIR:
    ...
    close(rcmd->fd);
      ...
      8f:	e8 05 0f 00 00       	call   f99 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      a7:	e8 05 0f 00 00       	call   fb1 <open>
      ...
      exit();
      ce:	e8 9e 0e 00 00       	call   f71 <exit>
    }
    runcmd(rcmd->cmd);
  ...
  case LIST:
    ...
    wait();
     103:	e8 71 0e 00 00       	call   f79 <wait>
    runcmd(lcmd->right);
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     127:	e8 55 0e 00 00       	call   f81 <pipe>
    ...
    if(fork1() == 0){
     ...
     14c:	e8 48 0e 00 00       	call   f99 <close>
      dup(p[1]);
     151:	8b 45 e0             	mov    -0x20(%ebp),%eax
     154:	89 04 24             	mov    %eax,(%esp)
     157:	e8 8d 0e 00 00       	call   fe9 <dup>
      close(p[0]);
     15c:	8b 45 dc             	mov    -0x24(%ebp),%eax
     15f:	89 04 24             	mov    %eax,(%esp)
     162:	e8 32 0e 00 00       	call   f99 <close>
      close(p[1]);
     167:	8b 45 e0             	mov    -0x20(%ebp),%eax
     16a:	89 04 24             	mov    %eax,(%esp)
     16d:	e8 27 0e 00 00       	call   f99 <close>
      runcmd(pcmd->left);
    ...
    if(fork1() == 0){
     ...
     190:	e8 04 0e 00 00       	call   f99 <close>
      dup(p[0]);
     195:	8b 45 dc             	mov    -0x24(%ebp),%eax
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 49 0e 00 00       	call   fe9 <dup>
      close(p[0]);
     1a0:	8b 45 dc             	mov    -0x24(%ebp),%eax
     1a3:	89 04 24             	mov    %eax,(%esp)
     1a6:	e8 ee 0d 00 00       	call   f99 <close>
      close(p[1]);
     1ab:	8b 45 e0             	mov    -0x20(%ebp),%eax
     1ae:	89 04 24             	mov    %eax,(%esp)
     1b1:	e8 e3 0d 00 00       	call   f99 <close>
      runcmd(pcmd->right);
    ...
    close(p[0]);
     ...
     1ca:	e8 ca 0d 00 00       	call   f99 <close>
    close(p[1]);
     1cf:	8b 45 e0             	mov    -0x20(%ebp),%eax
     1d2:	89 04 24             	mov    %eax,(%esp)
     1d5:	e8 bf 0d 00 00       	call   f99 <close>
    wait();
     1da:	e8 9a 0d 00 00       	call   f79 <wait>
    wait();
     1df:	e8 95 0d 00 00       	call   f79 <wait>
    break;
  ...
  exit();
     206:	e8 66 0d 00 00       	call   f71 <exit>
...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
    ...
    if(fd >= 3){
     ...
     282:	e8 12 0d 00 00       	call   f99 <close>
      break;
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     298:	e8 14 0d 00 00       	call   fb1 <open>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     2eb:	e8 f1 0c 00 00       	call   fe1 <chdir>
    ...
    wait();
     331:	e8 43 0c 00 00       	call   f79 <wait>
  while(getcmd(buf, sizeof(buf)) >= 0){
  ...
  exit();
     352:	e8 1a 0c 00 00       	call   f71 <exit>
...
panic(char *s)
{
  ...
  exit();
     378:	e8 f4 0b 00 00       	call   f71 <exit>
...
fork1(void)
{
  ...
  pid = fork();
     383:	e8 e1 0b 00 00       	call   f69 <fork>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     e30:	e8 54 01 00 00       	call   f89 <read>
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     e95:	e8 17 01 00 00       	call   fb1 <open>
...
SYSCALL(fkc)
     f59:	b8 17 00 00 00       	mov    $0x17,%eax
     f5e:	cd 40                	int    $0x40
     f60:	c3                   	ret    

00000f61 <hw>:
SYSCALL(hw)
     f61:	b8 16 00 00 00       	mov    $0x16,%eax
     f66:	cd 40                	int    $0x40
     f68:	c3                   	ret    

00000f69 <fork>:
SYSCALL(fork)
     f69:	b8 01 00 00 00       	mov    $0x1,%eax
     f6e:	cd 40                	int    $0x40
     f70:	c3                   	ret    

00000f71 <exit>:
SYSCALL(exit)
     f71:	b8 02 00 00 00       	mov    $0x2,%eax
     f76:	cd 40                	int    $0x40
     f78:	c3                   	ret    

00000f79 <wait>:
SYSCALL(wait)
     f79:	b8 03 00 00 00       	mov    $0x3,%eax
     f7e:	cd 40                	int    $0x40
     f80:	c3                   	ret    

00000f81 <pipe>:
SYSCALL(pipe)
     f81:	b8 04 00 00 00       	mov    $0x4,%eax
     f86:	cd 40                	int    $0x40
     f88:	c3                   	ret    

00000f89 <read>:
SYSCALL(read)
     f89:	b8 05 00 00 00       	mov    $0x5,%eax
     f8e:	cd 40                	int    $0x40
     f90:	c3                   	ret    

00000f91 <write>:
SYSCALL(write)
     f91:	b8 10 00 00 00       	mov    $0x10,%eax
     f96:	cd 40                	int    $0x40
     f98:	c3                   	ret    

00000f99 <close>:
SYSCALL(close)
     f99:	b8 15 00 00 00       	mov    $0x15,%eax
     f9e:	cd 40                	int    $0x40
     fa0:	c3                   	ret    

00000fa1 <kill>:
SYSCALL(kill)
     fa1:	b8 06 00 00 00       	mov    $0x6,%eax
     fa6:	cd 40                	int    $0x40
     fa8:	c3                   	ret    

00000fa9 <exec>:
SYSCALL(exec)
     fa9:	b8 07 00 00 00       	mov    $0x7,%eax
     fae:	cd 40                	int    $0x40
     fb0:	c3                   	ret    

00000fb1 <open>:
SYSCALL(open)
     fb1:	b8 0f 00 00 00       	mov    $0xf,%eax
     fb6:	cd 40                	int    $0x40
     fb8:	c3                   	ret    

00000fb9 <mknod>:
SYSCALL(mknod)
     fb9:	b8 11 00 00 00       	mov    $0x11,%eax
     fbe:	cd 40                	int    $0x40
     fc0:	c3                   	ret    

00000fc1 <unlink>:
SYSCALL(unlink)
     fc1:	b8 12 00 00 00       	mov    $0x12,%eax
     fc6:	cd 40                	int    $0x40
     fc8:	c3                   	ret    

00000fc9 <fstat>:
SYSCALL(fstat)
     fc9:	b8 08 00 00 00       	mov    $0x8,%eax
     fce:	cd 40                	int    $0x40
     fd0:	c3                   	ret    

00000fd1 <link>:
SYSCALL(link)
     fd1:	b8 13 00 00 00       	mov    $0x13,%eax
     fd6:	cd 40                	int    $0x40
     fd8:	c3                   	ret    

00000fd9 <mkdir>:
SYSCALL(mkdir)
     fd9:	b8 14 00 00 00       	mov    $0x14,%eax
     fde:	cd 40                	int    $0x40
     fe0:	c3                   	ret    

00000fe1 <chdir>:
SYSCALL(chdir)
     fe1:	b8 09 00 00 00       	mov    $0x9,%eax
     fe6:	cd 40                	int    $0x40
     fe8:	c3                   	ret    

00000fe9 <dup>:
SYSCALL(dup)
     fe9:	b8 0a 00 00 00       	mov    $0xa,%eax
     fee:	cd 40                	int    $0x40
     ff0:	c3                   	ret    

00000ff1 <getpid>:
SYSCALL(getpid)
     ff1:	b8 0b 00 00 00       	mov    $0xb,%eax
     ff6:	cd 40                	int    $0x40
     ff8:	c3                   	ret    

00000ff9 <sbrk>:
SYSCALL(sbrk)
     ff9:	b8 0c 00 00 00       	mov    $0xc,%eax
     ffe:	cd 40                	int    $0x40
    1000:	c3                   	ret    

00001001 <sleep>:
SYSCALL(sleep)
    1001:	b8 0d 00 00 00       	mov    $0xd,%eax
    1006:	cd 40                	int    $0x40
    1008:	c3                   	ret    

00001009 <uptime>:
SYSCALL(uptime)
    1009:	b8 0e 00 00 00       	mov    $0xe,%eax
    100e:	cd 40                	int    $0x40
    1010:	c3                   	ret    
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    1032:	e8 5a ff ff ff       	call   f91 <write>
}
    1037:	c9                   	leave  
    1038:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    13a4:	e8 50 fc ff ff       	call   ff9 <sbrk>
