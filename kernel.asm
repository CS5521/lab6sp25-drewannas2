...
80100087:	c7 44 24 04 47 82 10 	movl   $0x80108247,0x4(%esp)
8010008e:	80 
...
801001a7:	c7 04 24 4e 82 10 80 	movl   $0x8010824e,(%esp)
...
80100202:	75 0c                	jne    80100210 <bwrite+0x24>
    panic("bwrite");
80100204:	c7 04 24 5f 82 10 80 	movl   $0x8010825f,(%esp)
...
80100242:	75 0c                	jne    80100250 <brelse+0x24>
    panic("brelse");
80100244:	c7 04 24 66 82 10 80 	movl   $0x80108266,(%esp)
...
801003ed:	75 0c                	jne    801003fb <cprintf+0x33>
    panic("null fmt");
801003ef:	c7 04 24 6d 82 10 80 	movl   $0x8010826d,(%esp)
...
801004d6:	75 09                	jne    801004e1 <cprintf+0x119>
        s = "(null)";
801004d8:	c7 45 ec 76 82 10 80 	movl   $0x80108276,-0x14(%ebp)
      for(; *s; s++)
...
80100580:	c7 04 24 7d 82 10 80 	movl   $0x8010827d,(%esp)
...
80100592:	e8 31 fe ff ff       	call   801003c8 <cprintf>
  cprintf("\n");
80100597:	c7 04 24 91 82 10 80 	movl   $0x80108291,(%esp)
...
801005c9:	c7 04 24 93 82 10 80 	movl   $0x80108293,(%esp)
...
801006ba:	c7 04 24 97 82 10 80 	movl   $0x80108297,(%esp)
...
80100ad6:	c7 44 24 04 aa 82 10 	movl   $0x801082aa,0x4(%esp)
80100add:	80 
...
80100b48:	e8 be 29 00 00       	call   8010350b <end_op>
    cprintf("exec: fail\n");
80100b4d:	c7 04 24 b2 82 10 80 	movl   $0x801082b2,(%esp)
...
80100bb1:	e9 85 03 00 00       	jmp    80100f3b <exec+0x41d>
  ...
  if((pgdir = setupkvm()) == 0)
80100bb6:	e8 cf 6d 00 00       	call   8010798a <setupkvm>
...
80100c74:	e8 e7 70 00 00       	call   80107d60 <allocuvm>
...
80100cc6:	e8 b2 6f 00 00       	call   80107c7d <loaduvm>
...
80100d34:	e8 27 70 00 00       	call   80107d60 <allocuvm>
...
80100d59:	e8 75 72 00 00       	call   80107fd3 <clearpteu>
  sp = sz;
...
80100de8:	e8 a9 73 00 00       	call   80108196 <copyout>
...
80100e8f:	e8 02 73 00 00       	call   80108196 <copyout>
...
80100f24:	e8 3b 6b 00 00       	call   80107a64 <switchuvm>
  freevm(oldpgdir);
80100f29:	8b 45 cc             	mov    -0x34(%ebp),%eax
80100f2c:	89 04 24             	mov    %eax,(%esp)
80100f2f:	e8 08 70 00 00       	call   80107f3c <freevm>
  return 0;
...
80100f47:	e8 f0 6f 00 00       	call   80107f3c <freevm>
  if(ip){
...
80100f6f:	c7 44 24 04 be 82 10 	movl   $0x801082be,0x4(%esp)
80100f76:	80 
...
80100fff:	7f 0c                	jg     8010100d <filedup+0x28>
    panic("filedup");
80101001:	c7 04 24 c5 82 10 80 	movl   $0x801082c5,(%esp)
...
80101047:	7f 0c                	jg     80101055 <fileclose+0x28>
    panic("fileclose");
80101049:	c7 04 24 cd 82 10 80 	movl   $0x801082cd,(%esp)
...
801011fe:	eb 0c                	jmp    8010120c <fileread+0xba>
  ...
  panic("fileread");
80101200:	c7 04 24 d7 82 10 80 	movl   $0x801082d7,(%esp)
...
8010130c:	c7 04 24 e0 82 10 80 	movl   $0x801082e0,(%esp)
...
8010133c:	eb 0c                	jmp    8010134a <filewrite+0x13c>
  ...
  panic("filewrite");
8010133e:	c7 04 24 f0 82 10 80 	movl   $0x801082f0,(%esp)
...
80101517:	c7 04 24 fc 82 10 80 	movl   $0x801082fc,(%esp)
...
801015a6:	c7 04 24 12 83 10 80 	movl   $0x80108312,(%esp)
...
80101600:	c7 44 24 04 25 83 10 	movl   $0x80108325,0x4(%esp)
80101607:	80 
...
80101635:	c7 44 24 04 2c 83 10 	movl   $0x8010832c,0x4(%esp)
8010163c:	80 
...
801016af:	c7 04 24 34 83 10 80 	movl   $0x80108334,(%esp)
...
8010178a:	c7 04 24 87 83 10 80 	movl   $0x80108387,(%esp)
...
801018e3:	c7 04 24 99 83 10 80 	movl   $0x80108399,(%esp)
...
80101971:	7f 0c                	jg     8010197f <ilock+0x22>
    panic("ilock");
80101973:	c7 04 24 a9 83 10 80 	movl   $0x801083a9,(%esp)
...
80101a5a:	75 0c                	jne    80101a68 <ilock+0x10b>
      panic("ilock: no type");
80101a5c:	c7 04 24 af 83 10 80 	movl   $0x801083af,(%esp)
...
80101a90:	7f 0c                	jg     80101a9e <iunlock+0x34>
    panic("iunlock");
80101a92:	c7 04 24 be 83 10 80 	movl   $0x801083be,(%esp)
...
80101c7e:	c7 04 24 c6 83 10 80 	movl   $0x801083c6,(%esp)
...
80102122:	c7 04 24 d9 83 10 80 	movl   $0x801083d9,(%esp)
...
80102160:	c7 04 24 eb 83 10 80 	movl   $0x801083eb,(%esp)
...
80102243:	74 0c                	je     80102251 <dirlink+0x79>
      panic("dirlink read");
80102245:	c7 04 24 fa 83 10 80 	movl   $0x801083fa,(%esp)
...
801022ba:	74 0c                	je     801022c8 <dirlink+0xf0>
    panic("dirlink");
801022bc:	c7 04 24 07 84 10 80 	movl   $0x80108407,(%esp)
...
801025aa:	c7 44 24 04 0f 84 10 	movl   $0x8010840f,0x4(%esp)
801025b1:	80 
...
80102648:	75 0c                	jne    80102656 <idestart+0x18>
    panic("idestart");
8010264a:	c7 04 24 13 84 10 80 	movl   $0x80108413,(%esp)
...
80102663:	c7 04 24 1c 84 10 80 	movl   $0x8010841c,(%esp)
...
801026b5:	c7 04 24 13 84 10 80 	movl   $0x80108413,(%esp)
...
801028a3:	c7 04 24 2e 84 10 80 	movl   $0x8010842e,(%esp)
...
801028bc:	c7 04 24 44 84 10 80 	movl   $0x80108444,(%esp)
...
801028db:	c7 04 24 59 84 10 80 	movl   $0x80108459,(%esp)
...
801029e2:	c7 04 24 78 84 10 80 	movl   $0x80108478,(%esp)
...
80102a84:	c7 44 24 04 aa 84 10 	movl   $0x801084aa,0x4(%esp)
80102a8b:	80 
...
80102b3b:	76 0c                	jbe    80102b49 <kfree+0x36>
    panic("kfree");
80102b3d:	c7 04 24 af 84 10 80 	movl   $0x801084af,(%esp)
...
80103289:	c7 44 24 04 b5 84 10 	movl   $0x801084b5,0x4(%esp)
80103290:	80 
...
8010353a:	c7 04 24 b9 84 10 80 	movl   $0x801084b9,(%esp)
...
801036b4:	c7 04 24 c8 84 10 80 	movl   $0x801084c8,(%esp)
...
801036c9:	c7 04 24 de 84 10 80 	movl   $0x801084de,(%esp)
...
801037b4:	e8 d0 30 00 00       	call   80106889 <uartinit>
  pinit();         // process table
801037b9:	e8 f0 08 00 00       	call   801040ae <pinit>
  tvinit();        // trap vectors
801037be:	e8 8f 2c 00 00       	call   80106452 <tvinit>
  binit();         // buffer cache
...
801037f8:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
801037fb:	e8 4a 42 00 00       	call   80107a4a <switchkvm>
  seginit();
80103800:	e8 fa 3c 00 00       	call   801074ff <seginit>
  lapicinit();
...
8010382a:	c7 04 24 f9 84 10 80 	movl   $0x801084f9,(%esp)
80103831:	e8 92 cb ff ff       	call   801003c8 <cprintf>
  idtinit();       // load idt register
80103836:	e8 8b 2d 00 00       	call   801065c6 <idtinit>
...
801039bb:	00 
801039bc:	c7 44 24 04 10 85 10 	movl   $0x80108510,0x4(%esp)
801039c3:	80 
...
80103af9:	00 
80103afa:	c7 44 24 04 15 85 10 	movl   $0x80108515,0x4(%esp)
80103b01:	80 
...
80103b80:	c7 04 24 1a 85 10 80 	movl   $0x8010851a,(%esp)
...
80103bc9:	8b 04 85 54 85 10 80 	mov    -0x7fef7aac(,%eax,4),%eax
...
80103c48:	c7 04 24 34 85 10 80 	movl   $0x80108534,(%esp)
...
80103d7d:	c7 44 24 04 68 85 10 	movl   $0x80108568,0x4(%esp)
80103d84:	80 
...
801040b4:	c7 44 24 04 70 85 10 	movl   $0x80108570,0x4(%esp)
801040bb:	80 
...
801040ff:	c7 04 24 78 85 10 80 	movl   $0x80108578,(%esp)
...
80104153:	c7 04 24 9e 85 10 80 	movl   $0x8010859e,(%esp)
...
80104241:	ba 0d 64 10 80       	mov    $0x8010640d,%edx
...
8010429f:	e8 e6 36 00 00       	call   8010798a <setupkvm>
...
801042b4:	c7 04 24 ae 85 10 80 	movl   $0x801085ae,(%esp)
...
801042da:	e8 16 39 00 00       	call   80107bf5 <inituvm>
  p->sz = PGSIZE;
...
8010437a:	00 
8010437b:	c7 44 24 04 c7 85 10 	movl   $0x801085c7,0x4(%esp)
80104382:	80 
80104383:	89 04 24             	mov    %eax,(%esp)
80104386:	e8 9f 0e 00 00       	call   8010522a <safestrcpy>
  p->cwd = namei("/");
8010438b:	c7 04 24 d0 85 10 80 	movl   $0x801085d0,(%esp)
...
801043f9:	e8 62 39 00 00       	call   80107d60 <allocuvm>
...
80104430:	e8 41 3a 00 00       	call   80107e76 <deallocuvm>
...
80104453:	e8 0c 36 00 00       	call   80107a64 <switchuvm>
  return 0;
...
8010449a:	e8 7a 3b 00 00       	call   80108019 <copyuvm>
...
801045dc:	75 0c                	jne    801045ea <exit+0x24>
    panic("init exiting");
801045de:	c7 04 24 d2 85 10 80 	movl   $0x801085d2,(%esp)
...
801046bf:	e8 c3 01 00 00       	call   80104887 <sched>
  panic("zombie exit");
801046c4:	c7 04 24 df 85 10 80 	movl   $0x801085df,(%esp)
...
80104749:	e8 ee 37 00 00       	call   80107f3c <freevm>
        p->pid = 0;
...
80104830:	e8 2f 32 00 00       	call   80107a64 <switchuvm>
      p->state = RUNNING;
...
80104852:	e8 44 0a 00 00       	call   8010529b <swtch>
      switchkvm();
80104857:	e8 ee 31 00 00       	call   80107a4a <switchkvm>
...
801048a5:	c7 04 24 eb 85 10 80 	movl   $0x801085eb,(%esp)
...
801048bf:	74 0c                	je     801048cd <sched+0x46>
    panic("sched locks");
801048c1:	c7 04 24 fd 85 10 80 	movl   $0x801085fd,(%esp)
...
801048d6:	75 0c                	jne    801048e4 <sched+0x5d>
    panic("sched running");
801048d8:	c7 04 24 09 86 10 80 	movl   $0x80108609,(%esp)
...
801048f2:	c7 04 24 17 86 10 80 	movl   $0x80108617,(%esp)
...
801049b8:	75 0c                	jne    801049c6 <sleep+0x20>
    panic("sleep");
801049ba:	c7 04 24 2b 86 10 80 	movl   $0x8010862b,(%esp)
...
801049cc:	c7 04 24 31 86 10 80 	movl   $0x80108631,(%esp)
...
80104b6a:	eb 07                	jmp    80104b73 <procdump+0x56>
      ...
      state = "???";
80104b6c:	c7 45 ec 42 86 10 80 	movl   $0x80108642,-0x14(%ebp)
...
80104b8e:	c7 04 24 46 86 10 80 	movl   $0x80108646,(%esp)
...
80104bd4:	c7 04 24 4f 86 10 80 	movl   $0x8010864f,(%esp)
...
80104bf3:	75 d4                	jne    80104bc9 <procdump+0xac>
    ...
    cprintf("\n");
80104bf5:	c7 04 24 53 86 10 80 	movl   $0x80108653,(%esp)
...
80104c20:	c7 44 24 04 7f 86 10 	movl   $0x8010867f,0x4(%esp)
80104c27:	80 
...
80104db1:	74 0c                	je     80104dbf <acquire+0x27>
    panic("acquire");
80104db3:	c7 04 24 8a 86 10 80 	movl   $0x8010868a,(%esp)
...
80104e13:	75 0c                	jne    80104e21 <release+0x21>
    panic("release");
80104e15:	c7 04 24 92 86 10 80 	movl   $0x80108692,(%esp)
...
80104f65:	c7 04 24 9a 86 10 80 	movl   $0x8010869a,(%esp)
...
80104f8d:	79 0c                	jns    80104f9b <popcli+0x4a>
    panic("popcli");
80104f8f:	c7 04 24 b1 86 10 80 	movl   $0x801086b1,(%esp)
...
8010548a:	c7 04 24 b8 86 10 80 	movl   $0x801086b8,(%esp)
...
80105920:	c7 04 24 d4 86 10 80 	movl   $0x801086d4,(%esp)
...
801059ba:	c7 44 24 04 e6 86 10 	movl   $0x801086e6,0x4(%esp)
801059c1:	80 
...
801059d5:	c7 44 24 04 e8 86 10 	movl   $0x801086e8,0x4(%esp)
801059dc:	80 
...
80105a2e:	c7 04 24 eb 86 10 80 	movl   $0x801086eb,(%esp)
...
80105aa5:	74 0c                	je     80105ab3 <sys_unlink+0x15a>
    panic("unlink: writei");
80105aa7:	c7 04 24 fd 86 10 80 	movl   $0x801086fd,(%esp)
...
80105c01:	75 0c                	jne    80105c0f <create+0xde>
    panic("create: ialloc");
80105c03:	c7 04 24 0c 87 10 80 	movl   $0x8010870c,(%esp)
...
80105c71:	c7 44 24 04 e6 86 10 	movl   $0x801086e6,0x4(%esp)
80105c78:	80 
...
80105c92:	c7 44 24 04 e8 86 10 	movl   $0x801086e8,0x4(%esp)
80105c99:	80 
...
80105ca7:	79 0c                	jns    80105cb5 <create+0x184>
      panic("create dots");
80105ca9:	c7 04 24 1b 87 10 80 	movl   $0x8010871b,(%esp)
...
80105cd5:	c7 04 24 27 87 10 80 	movl   $0x80108727,(%esp)
...
80106235:	e8 19 f1 ff ff       	call   80105353 <argint>
8010623a:	85 c0                	test   %eax,%eax
8010623c:	79 07                	jns    80106245 <sys_fkc+0x24>
    return -1;
8010623e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106243:	eb 16                	jmp    8010625b <sys_fkc+0x3a>
  }
  else if (n == 0){
80106245:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106248:	85 c0                	test   %eax,%eax
8010624a:	75 0a                	jne    80106256 <sys_fkc+0x35>
    forks = 0;
8010624c:	c7 05 24 b6 10 80 00 	movl   $0x0,0x8010b624
80106253:	00 00 00 
  }
  return forks;
80106256:	a1 24 b6 10 80       	mov    0x8010b624,%eax
}
8010625b:	c9                   	leave  
8010625c:	c3                   	ret    
...
80106260:	83 ec 18             	sub    $0x18,%esp
  cprintf("hello world!\n");
80106263:	c7 04 24 37 87 10 80 	movl   $0x80108737,(%esp)
8010626a:	e8 59 a1 ff ff       	call   801003c8 <cprintf>
  return 0;
...
80106279:	83 ec 08             	sub    $0x8,%esp
  forks++;
8010627c:	a1 24 b6 10 80       	mov    0x8010b624,%eax
80106281:	83 c0 01             	add    $0x1,%eax
80106284:	a3 24 b6 10 80       	mov    %eax,0x8010b624
  return fork();
80106289:	e8 d1 e1 ff ff       	call   8010445f <fork>
}
8010628e:	c9                   	leave  
8010628f:	c3                   	ret    
...
80106293:	83 ec 08             	sub    $0x8,%esp
  exit();
80106296:	e8 2b e3 ff ff       	call   801045c6 <exit>
...
801062a5:	83 ec 08             	sub    $0x8,%esp
  return wait();
801062a8:	e8 23 e4 ff ff       	call   801046d0 <wait>
}
801062ad:	c9                   	leave  
801062ae:	c3                   	ret    
...
801062b2:	83 ec 28             	sub    $0x28,%esp
  int pid;
...
801062c3:	e8 8b f0 ff ff       	call   80105353 <argint>
801062c8:	85 c0                	test   %eax,%eax
801062ca:	79 07                	jns    801062d3 <sys_kill+0x24>
    return -1;
801062cc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062d1:	eb 0b                	jmp    801062de <sys_kill+0x2f>
  return kill(pid);
801062d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062d6:	89 04 24             	mov    %eax,(%esp)
801062d9:	e8 c7 e7 ff ff       	call   80104aa5 <kill>
}
801062de:	c9                   	leave  
801062df:	c3                   	ret    
...
801062e3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801062e6:	e8 76 de ff ff       	call   80104161 <myproc>
...
8010630b:	79 07                	jns    80106314 <sys_sbrk+0x24>
    return -1;
8010630d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106312:	eb 23                	jmp    80106337 <sys_sbrk+0x47>
  addr = myproc()->sz;
80106314:	e8 48 de ff ff       	call   80104161 <myproc>
80106319:	8b 00                	mov    (%eax),%eax
8010631b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
8010631e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106321:	89 04 24             	mov    %eax,(%esp)
80106324:	e8 98 e0 ff ff       	call   801043c1 <growproc>
80106329:	85 c0                	test   %eax,%eax
8010632b:	79 07                	jns    80106334 <sys_sbrk+0x44>
    return -1;
8010632d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106332:	eb 03                	jmp    80106337 <sys_sbrk+0x47>
  return addr;
...
8010633c:	83 ec 28             	sub    $0x28,%esp
  int n;
  uint ticks0;
...
8010634d:	e8 01 f0 ff ff       	call   80105353 <argint>
80106352:	85 c0                	test   %eax,%eax
80106354:	79 07                	jns    8010635d <sys_sleep+0x24>
    return -1;
80106356:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010635b:	eb 6b                	jmp    801063c8 <sys_sleep+0x8f>
  acquire(&tickslock);
8010635d:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
80106364:	e8 2f ea ff ff       	call   80104d98 <acquire>
  ticks0 = ticks;
80106369:	a1 20 65 11 80       	mov    0x80116520,%eax
8010636e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106371:	eb 33                	jmp    801063a6 <sys_sleep+0x6d>
    if(myproc()->killed){
80106373:	e8 e9 dd ff ff       	call   80104161 <myproc>
80106378:	8b 40 24             	mov    0x24(%eax),%eax
8010637b:	85 c0                	test   %eax,%eax
8010637d:	74 13                	je     80106392 <sys_sleep+0x59>
      release(&tickslock);
8010637f:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
80106386:	e8 75 ea ff ff       	call   80104e00 <release>
      return -1;
8010638b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106390:	eb 36                	jmp    801063c8 <sys_sleep+0x8f>
    }
    sleep(&ticks, &tickslock);
80106392:	c7 44 24 04 e0 5c 11 	movl   $0x80115ce0,0x4(%esp)
80106399:	80 
8010639a:	c7 04 24 20 65 11 80 	movl   $0x80116520,(%esp)
801063a1:	e8 00 e6 ff ff       	call   801049a6 <sleep>
  while(ticks - ticks0 < n){
801063a6:	a1 20 65 11 80       	mov    0x80116520,%eax
801063ab:	2b 45 f4             	sub    -0xc(%ebp),%eax
801063ae:	89 c2                	mov    %eax,%edx
801063b0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063b3:	39 c2                	cmp    %eax,%edx
801063b5:	72 bc                	jb     80106373 <sys_sleep+0x3a>
  }
  release(&tickslock);
801063b7:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
801063be:	e8 3d ea ff ff       	call   80104e00 <release>
  return 0;
...
801063cd:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
801063d0:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
801063d7:	e8 bc e9 ff ff       	call   80104d98 <acquire>
  xticks = ticks;
801063dc:	a1 20 65 11 80       	mov    0x80116520,%eax
801063e1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
801063e4:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
801063eb:	e8 10 ea ff ff       	call   80104e00 <release>
  return xticks;
...
801063f6:	06                   	push   %es
  pushl %fs
801063f7:	0f a0                	push   %fs
  pushl %gs
801063f9:	0f a8                	push   %gs
  pushal
801063fb:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801063fc:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106400:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106402:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80106404:	54                   	push   %esp
  call trap
80106405:	e8 d8 01 00 00       	call   801065e2 <trap>
  addl $4, %esp
8010640a:	83 c4 04             	add    $0x4,%esp
...
8010640d:	61                   	popa   
  popl %gs
8010640e:	0f a9                	pop    %gs
  popl %fs
80106410:	0f a1                	pop    %fs
  popl %es
80106412:	07                   	pop    %es
  popl %ds
80106413:	1f                   	pop    %ds
...
80106421:	83 e8 01             	sub    $0x1,%eax
80106424:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106428:	8b 45 08             	mov    0x8(%ebp),%eax
8010642b:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
8010642f:	8b 45 08             	mov    0x8(%ebp),%eax
80106432:	c1 e8 10             	shr    $0x10,%eax
80106435:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80106439:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010643c:	0f 01 18             	lidtl  (%eax)
}
8010643f:	c9                   	leave  
80106440:	c3                   	ret    
...
80106444:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
80106447:	0f 20 d0             	mov    %cr2,%eax
8010644a:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
...
80106455:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
80106458:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010645f:	e9 c3 00 00 00       	jmp    80106527 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106464:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106467:	8b 04 85 80 b0 10 80 	mov    -0x7fef4f80(,%eax,4),%eax
8010646e:	89 c2                	mov    %eax,%edx
80106470:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106473:	66 89 14 c5 20 5d 11 	mov    %dx,-0x7feea2e0(,%eax,8)
8010647a:	80 
8010647b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010647e:	66 c7 04 c5 22 5d 11 	movw   $0x8,-0x7feea2de(,%eax,8)
80106485:	80 08 00 
80106488:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010648b:	0f b6 14 c5 24 5d 11 	movzbl -0x7feea2dc(,%eax,8),%edx
80106492:	80 
80106493:	83 e2 e0             	and    $0xffffffe0,%edx
80106496:	88 14 c5 24 5d 11 80 	mov    %dl,-0x7feea2dc(,%eax,8)
8010649d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064a0:	0f b6 14 c5 24 5d 11 	movzbl -0x7feea2dc(,%eax,8),%edx
801064a7:	80 
801064a8:	83 e2 1f             	and    $0x1f,%edx
801064ab:	88 14 c5 24 5d 11 80 	mov    %dl,-0x7feea2dc(,%eax,8)
801064b2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064b5:	0f b6 14 c5 25 5d 11 	movzbl -0x7feea2db(,%eax,8),%edx
801064bc:	80 
801064bd:	83 e2 f0             	and    $0xfffffff0,%edx
801064c0:	83 ca 0e             	or     $0xe,%edx
801064c3:	88 14 c5 25 5d 11 80 	mov    %dl,-0x7feea2db(,%eax,8)
801064ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064cd:	0f b6 14 c5 25 5d 11 	movzbl -0x7feea2db(,%eax,8),%edx
801064d4:	80 
801064d5:	83 e2 ef             	and    $0xffffffef,%edx
801064d8:	88 14 c5 25 5d 11 80 	mov    %dl,-0x7feea2db(,%eax,8)
801064df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064e2:	0f b6 14 c5 25 5d 11 	movzbl -0x7feea2db(,%eax,8),%edx
801064e9:	80 
801064ea:	83 e2 9f             	and    $0xffffff9f,%edx
801064ed:	88 14 c5 25 5d 11 80 	mov    %dl,-0x7feea2db(,%eax,8)
801064f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064f7:	0f b6 14 c5 25 5d 11 	movzbl -0x7feea2db(,%eax,8),%edx
801064fe:	80 
801064ff:	83 ca 80             	or     $0xffffff80,%edx
80106502:	88 14 c5 25 5d 11 80 	mov    %dl,-0x7feea2db(,%eax,8)
80106509:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010650c:	8b 04 85 80 b0 10 80 	mov    -0x7fef4f80(,%eax,4),%eax
80106513:	c1 e8 10             	shr    $0x10,%eax
80106516:	89 c2                	mov    %eax,%edx
80106518:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010651b:	66 89 14 c5 26 5d 11 	mov    %dx,-0x7feea2da(,%eax,8)
80106522:	80 
  for(i = 0; i < 256; i++)
80106523:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106527:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
8010652e:	0f 8e 30 ff ff ff    	jle    80106464 <tvinit+0x12>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106534:	a1 80 b1 10 80       	mov    0x8010b180,%eax
80106539:	66 a3 20 5f 11 80    	mov    %ax,0x80115f20
8010653f:	66 c7 05 22 5f 11 80 	movw   $0x8,0x80115f22
80106546:	08 00 
80106548:	0f b6 05 24 5f 11 80 	movzbl 0x80115f24,%eax
8010654f:	83 e0 e0             	and    $0xffffffe0,%eax
80106552:	a2 24 5f 11 80       	mov    %al,0x80115f24
80106557:	0f b6 05 24 5f 11 80 	movzbl 0x80115f24,%eax
8010655e:	83 e0 1f             	and    $0x1f,%eax
80106561:	a2 24 5f 11 80       	mov    %al,0x80115f24
80106566:	0f b6 05 25 5f 11 80 	movzbl 0x80115f25,%eax
8010656d:	83 c8 0f             	or     $0xf,%eax
80106570:	a2 25 5f 11 80       	mov    %al,0x80115f25
80106575:	0f b6 05 25 5f 11 80 	movzbl 0x80115f25,%eax
8010657c:	83 e0 ef             	and    $0xffffffef,%eax
8010657f:	a2 25 5f 11 80       	mov    %al,0x80115f25
80106584:	0f b6 05 25 5f 11 80 	movzbl 0x80115f25,%eax
8010658b:	83 c8 60             	or     $0x60,%eax
8010658e:	a2 25 5f 11 80       	mov    %al,0x80115f25
80106593:	0f b6 05 25 5f 11 80 	movzbl 0x80115f25,%eax
8010659a:	83 c8 80             	or     $0xffffff80,%eax
8010659d:	a2 25 5f 11 80       	mov    %al,0x80115f25
801065a2:	a1 80 b1 10 80       	mov    0x8010b180,%eax
801065a7:	c1 e8 10             	shr    $0x10,%eax
801065aa:	66 a3 26 5f 11 80    	mov    %ax,0x80115f26

  initlock(&tickslock, "time");
801065b0:	c7 44 24 04 48 87 10 	movl   $0x80108748,0x4(%esp)
801065b7:	80 
801065b8:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
801065bf:	e8 b3 e7 ff ff       	call   80104d77 <initlock>
}
801065c4:	c9                   	leave  
801065c5:	c3                   	ret    
...
801065c9:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801065cc:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801065d3:	00 
801065d4:	c7 04 24 20 5d 11 80 	movl   $0x80115d20,(%esp)
801065db:	e8 38 fe ff ff       	call   80106418 <lidt>
}
801065e0:	c9                   	leave  
801065e1:	c3                   	ret    
...
801065e8:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
801065eb:	8b 45 08             	mov    0x8(%ebp),%eax
801065ee:	8b 40 30             	mov    0x30(%eax),%eax
801065f1:	83 f8 40             	cmp    $0x40,%eax
801065f4:	75 3c                	jne    80106632 <trap+0x50>
    if(myproc()->killed)
801065f6:	e8 66 db ff ff       	call   80104161 <myproc>
801065fb:	8b 40 24             	mov    0x24(%eax),%eax
801065fe:	85 c0                	test   %eax,%eax
80106600:	74 05                	je     80106607 <trap+0x25>
      exit();
80106602:	e8 bf df ff ff       	call   801045c6 <exit>
    myproc()->tf = tf;
80106607:	e8 55 db ff ff       	call   80104161 <myproc>
8010660c:	8b 55 08             	mov    0x8(%ebp),%edx
8010660f:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106612:	e8 0a ee ff ff       	call   80105421 <syscall>
    if(myproc()->killed)
80106617:	e8 45 db ff ff       	call   80104161 <myproc>
8010661c:	8b 40 24             	mov    0x24(%eax),%eax
8010661f:	85 c0                	test   %eax,%eax
80106621:	74 0a                	je     8010662d <trap+0x4b>
      exit();
80106623:	e8 9e df ff ff       	call   801045c6 <exit>
    return;
80106628:	e9 19 02 00 00       	jmp    80106846 <trap+0x264>
8010662d:	e9 14 02 00 00       	jmp    80106846 <trap+0x264>
  }

  switch(tf->trapno){
80106632:	8b 45 08             	mov    0x8(%ebp),%eax
80106635:	8b 40 30             	mov    0x30(%eax),%eax
80106638:	83 e8 20             	sub    $0x20,%eax
8010663b:	83 f8 1f             	cmp    $0x1f,%eax
8010663e:	0f 87 b1 00 00 00    	ja     801066f5 <trap+0x113>
80106644:	8b 04 85 f0 87 10 80 	mov    -0x7fef7810(,%eax,4),%eax
8010664b:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
8010664d:	e8 78 da ff ff       	call   801040ca <cpuid>
80106652:	85 c0                	test   %eax,%eax
80106654:	75 31                	jne    80106687 <trap+0xa5>
      acquire(&tickslock);
80106656:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
8010665d:	e8 36 e7 ff ff       	call   80104d98 <acquire>
      ticks++;
80106662:	a1 20 65 11 80       	mov    0x80116520,%eax
80106667:	83 c0 01             	add    $0x1,%eax
8010666a:	a3 20 65 11 80       	mov    %eax,0x80116520
      wakeup(&ticks);
8010666f:	c7 04 24 20 65 11 80 	movl   $0x80116520,(%esp)
80106676:	e8 ff e3 ff ff       	call   80104a7a <wakeup>
      release(&tickslock);
8010667b:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
80106682:	e8 79 e7 ff ff       	call   80104e00 <release>
    }
    lapiceoi();
80106687:	e8 c5 c8 ff ff       	call   80102f51 <lapiceoi>
    break;
8010668c:	e9 37 01 00 00       	jmp    801067c8 <trap+0x1e6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106691:	e8 32 c1 ff ff       	call   801027c8 <ideintr>
    lapiceoi();
80106696:	e8 b6 c8 ff ff       	call   80102f51 <lapiceoi>
    break;
8010669b:	e9 28 01 00 00       	jmp    801067c8 <trap+0x1e6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
801066a0:	e8 c1 c6 ff ff       	call   80102d66 <kbdintr>
    lapiceoi();
801066a5:	e8 a7 c8 ff ff       	call   80102f51 <lapiceoi>
    break;
801066aa:	e9 19 01 00 00       	jmp    801067c8 <trap+0x1e6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801066af:	e8 7b 03 00 00       	call   80106a2f <uartintr>
    lapiceoi();
801066b4:	e8 98 c8 ff ff       	call   80102f51 <lapiceoi>
    break;
801066b9:	e9 0a 01 00 00       	jmp    801067c8 <trap+0x1e6>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801066be:	8b 45 08             	mov    0x8(%ebp),%eax
801066c1:	8b 70 38             	mov    0x38(%eax),%esi
            cpuid(), tf->cs, tf->eip);
801066c4:	8b 45 08             	mov    0x8(%ebp),%eax
801066c7:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801066cb:	0f b7 d8             	movzwl %ax,%ebx
801066ce:	e8 f7 d9 ff ff       	call   801040ca <cpuid>
801066d3:	89 74 24 0c          	mov    %esi,0xc(%esp)
801066d7:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801066db:	89 44 24 04          	mov    %eax,0x4(%esp)
801066df:	c7 04 24 50 87 10 80 	movl   $0x80108750,(%esp)
801066e6:	e8 dd 9c ff ff       	call   801003c8 <cprintf>
    lapiceoi();
801066eb:	e8 61 c8 ff ff       	call   80102f51 <lapiceoi>
    break;
801066f0:	e9 d3 00 00 00       	jmp    801067c8 <trap+0x1e6>

  //PAGEBREAK: 13
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
801066f5:	e8 67 da ff ff       	call   80104161 <myproc>
801066fa:	85 c0                	test   %eax,%eax
801066fc:	74 11                	je     8010670f <trap+0x12d>
...
8010670d:	75 40                	jne    8010674f <trap+0x16d>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010670f:	e8 2d fd ff ff       	call   80106441 <rcr2>
80106714:	89 c3                	mov    %eax,%ebx
80106716:	8b 45 08             	mov    0x8(%ebp),%eax
80106719:	8b 70 38             	mov    0x38(%eax),%esi
8010671c:	e8 a9 d9 ff ff       	call   801040ca <cpuid>
80106721:	8b 55 08             	mov    0x8(%ebp),%edx
80106724:	8b 52 30             	mov    0x30(%edx),%edx
80106727:	89 5c 24 10          	mov    %ebx,0x10(%esp)
8010672b:	89 74 24 0c          	mov    %esi,0xc(%esp)
8010672f:	89 44 24 08          	mov    %eax,0x8(%esp)
80106733:	89 54 24 04          	mov    %edx,0x4(%esp)
80106737:	c7 04 24 74 87 10 80 	movl   $0x80108774,(%esp)
8010673e:	e8 85 9c ff ff       	call   801003c8 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80106743:	c7 04 24 a6 87 10 80 	movl   $0x801087a6,(%esp)
8010674a:	e8 13 9e ff ff       	call   80100562 <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010674f:	e8 ed fc ff ff       	call   80106441 <rcr2>
80106754:	89 c6                	mov    %eax,%esi
80106756:	8b 45 08             	mov    0x8(%ebp),%eax
80106759:	8b 40 38             	mov    0x38(%eax),%eax
8010675c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010675f:	e8 66 d9 ff ff       	call   801040ca <cpuid>
80106764:	89 c3                	mov    %eax,%ebx
80106766:	8b 45 08             	mov    0x8(%ebp),%eax
80106769:	8b 78 34             	mov    0x34(%eax),%edi
8010676c:	89 7d e0             	mov    %edi,-0x20(%ebp)
8010676f:	8b 45 08             	mov    0x8(%ebp),%eax
80106772:	8b 78 30             	mov    0x30(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80106775:	e8 e7 d9 ff ff       	call   80104161 <myproc>
8010677a:	8d 50 6c             	lea    0x6c(%eax),%edx
8010677d:	89 55 dc             	mov    %edx,-0x24(%ebp)
80106780:	e8 dc d9 ff ff       	call   80104161 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106785:	8b 40 10             	mov    0x10(%eax),%eax
80106788:	89 74 24 1c          	mov    %esi,0x1c(%esp)
8010678c:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010678f:	89 4c 24 18          	mov    %ecx,0x18(%esp)
80106793:	89 5c 24 14          	mov    %ebx,0x14(%esp)
80106797:	8b 4d e0             	mov    -0x20(%ebp),%ecx
8010679a:	89 4c 24 10          	mov    %ecx,0x10(%esp)
8010679e:	89 7c 24 0c          	mov    %edi,0xc(%esp)
801067a2:	8b 55 dc             	mov    -0x24(%ebp),%edx
801067a5:	89 54 24 08          	mov    %edx,0x8(%esp)
801067a9:	89 44 24 04          	mov    %eax,0x4(%esp)
801067ad:	c7 04 24 ac 87 10 80 	movl   $0x801087ac,(%esp)
801067b4:	e8 0f 9c ff ff       	call   801003c8 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801067b9:	e8 a3 d9 ff ff       	call   80104161 <myproc>
801067be:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801067c5:	eb 01                	jmp    801067c8 <trap+0x1e6>
    break;
801067c7:	90                   	nop
  }
...
801067cf:	74 23                	je     801067f4 <trap+0x212>
801067d1:	e8 8b d9 ff ff       	call   80104161 <myproc>
801067d6:	8b 40 24             	mov    0x24(%eax),%eax
801067d9:	85 c0                	test   %eax,%eax
801067db:	74 17                	je     801067f4 <trap+0x212>
801067dd:	8b 45 08             	mov    0x8(%ebp),%eax
801067e0:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801067e4:	0f b7 c0             	movzwl %ax,%eax
801067e7:	83 e0 03             	and    $0x3,%eax
801067ea:	83 f8 03             	cmp    $0x3,%eax
801067ed:	75 05                	jne    801067f4 <trap+0x212>
    exit();
801067ef:	e8 d2 dd ff ff       	call   801045c6 <exit>

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801067f4:	e8 68 d9 ff ff       	call   80104161 <myproc>
801067f9:	85 c0                	test   %eax,%eax
801067fb:	74 1d                	je     8010681a <trap+0x238>
801067fd:	e8 5f d9 ff ff       	call   80104161 <myproc>
80106802:	8b 40 0c             	mov    0xc(%eax),%eax
80106805:	83 f8 04             	cmp    $0x4,%eax
80106808:	75 10                	jne    8010681a <trap+0x238>
     tf->trapno == T_IRQ0+IRQ_TIMER)
8010680a:	8b 45 08             	mov    0x8(%ebp),%eax
8010680d:	8b 40 30             	mov    0x30(%eax),%eax
  if(myproc() && myproc()->state == RUNNING &&
80106810:	83 f8 20             	cmp    $0x20,%eax
80106813:	75 05                	jne    8010681a <trap+0x238>
    yield();
80106815:	e8 1c e1 ff ff       	call   80104936 <yield>

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010681a:	e8 42 d9 ff ff       	call   80104161 <myproc>
8010681f:	85 c0                	test   %eax,%eax
80106821:	74 23                	je     80106846 <trap+0x264>
80106823:	e8 39 d9 ff ff       	call   80104161 <myproc>
80106828:	8b 40 24             	mov    0x24(%eax),%eax
8010682b:	85 c0                	test   %eax,%eax
8010682d:	74 17                	je     80106846 <trap+0x264>
...
8010683f:	75 05                	jne    80106846 <trap+0x264>
    exit();
80106841:	e8 80 dd ff ff       	call   801045c6 <exit>
}
80106846:	83 c4 3c             	add    $0x3c,%esp
80106849:	5b                   	pop    %ebx
8010684a:	5e                   	pop    %esi
8010684b:	5f                   	pop    %edi
8010684c:	5d                   	pop    %ebp
...
80106851:	83 ec 14             	sub    $0x14,%esp
80106854:	8b 45 08             	mov    0x8(%ebp),%eax
80106857:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010685b:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
8010685f:	89 c2                	mov    %eax,%edx
80106861:	ec                   	in     (%dx),%al
80106862:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106865:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106869:	c9                   	leave  
8010686a:	c3                   	ret    
...
80106871:	8b 55 08             	mov    0x8(%ebp),%edx
80106874:	8b 45 0c             	mov    0xc(%ebp),%eax
80106877:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
8010687b:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010687e:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106882:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
8010688c:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
8010688f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106896:	00 
80106897:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010689e:	e8 c8 ff ff ff       	call   8010686b <outb>

  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
801068a3:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
801068aa:	00 
801068ab:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801068b2:	e8 b4 ff ff ff       	call   8010686b <outb>
  outb(COM1+0, 115200/9600);
801068b7:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
801068be:	00 
801068bf:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801068c6:	e8 a0 ff ff ff       	call   8010686b <outb>
  outb(COM1+1, 0);
801068cb:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801068d2:	00 
801068d3:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801068da:	e8 8c ff ff ff       	call   8010686b <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
801068df:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801068e6:	00 
801068e7:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801068ee:	e8 78 ff ff ff       	call   8010686b <outb>
  outb(COM1+4, 0);
801068f3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801068fa:	00 
801068fb:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106902:	e8 64 ff ff ff       	call   8010686b <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106907:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010690e:	00 
8010690f:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106916:	e8 50 ff ff ff       	call   8010686b <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
8010691b:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106922:	e8 27 ff ff ff       	call   8010684e <inb>
80106927:	3c ff                	cmp    $0xff,%al
80106929:	75 02                	jne    8010692d <uartinit+0xa4>
    return;
8010692b:	eb 5e                	jmp    8010698b <uartinit+0x102>
  uart = 1;
8010692d:	c7 05 28 b6 10 80 01 	movl   $0x1,0x8010b628
80106934:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106937:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010693e:	e8 0b ff ff ff       	call   8010684e <inb>
  inb(COM1+0);
80106943:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010694a:	e8 ff fe ff ff       	call   8010684e <inb>
  ioapicenable(IRQ_COM1, 0);
8010694f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106956:	00 
80106957:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
8010695e:	e8 dc c0 ff ff       	call   80102a3f <ioapicenable>

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106963:	c7 45 f4 70 88 10 80 	movl   $0x80108870,-0xc(%ebp)
8010696a:	eb 15                	jmp    80106981 <uartinit+0xf8>
    uartputc(*p);
8010696c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010696f:	0f b6 00             	movzbl (%eax),%eax
80106972:	0f be c0             	movsbl %al,%eax
80106975:	89 04 24             	mov    %eax,(%esp)
80106978:	e8 10 00 00 00       	call   8010698d <uartputc>
  for(p="xv6...\n"; *p; p++)
...
80106989:	75 e1                	jne    8010696c <uartinit+0xe3>
}
8010698b:	c9                   	leave  
8010698c:	c3                   	ret    
...
80106990:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
80106993:	a1 28 b6 10 80       	mov    0x8010b628,%eax
80106998:	85 c0                	test   %eax,%eax
8010699a:	75 02                	jne    8010699e <uartputc+0x11>
    return;
8010699c:	eb 4b                	jmp    801069e9 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010699e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801069a5:	eb 10                	jmp    801069b7 <uartputc+0x2a>
    microdelay(10);
801069a7:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801069ae:	e8 c3 c5 ff ff       	call   80102f76 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801069b3:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801069b7:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
801069bb:	7f 16                	jg     801069d3 <uartputc+0x46>
801069bd:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801069c4:	e8 85 fe ff ff       	call   8010684e <inb>
801069c9:	0f b6 c0             	movzbl %al,%eax
801069cc:	83 e0 20             	and    $0x20,%eax
801069cf:	85 c0                	test   %eax,%eax
801069d1:	74 d4                	je     801069a7 <uartputc+0x1a>
  outb(COM1+0, c);
801069d3:	8b 45 08             	mov    0x8(%ebp),%eax
801069d6:	0f b6 c0             	movzbl %al,%eax
801069d9:	89 44 24 04          	mov    %eax,0x4(%esp)
801069dd:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801069e4:	e8 82 fe ff ff       	call   8010686b <outb>
}
801069e9:	c9                   	leave  
801069ea:	c3                   	ret    
...
801069ee:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
801069f1:	a1 28 b6 10 80       	mov    0x8010b628,%eax
801069f6:	85 c0                	test   %eax,%eax
801069f8:	75 07                	jne    80106a01 <uartgetc+0x16>
    return -1;
801069fa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069ff:	eb 2c                	jmp    80106a2d <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106a01:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106a08:	e8 41 fe ff ff       	call   8010684e <inb>
80106a0d:	0f b6 c0             	movzbl %al,%eax
80106a10:	83 e0 01             	and    $0x1,%eax
80106a13:	85 c0                	test   %eax,%eax
80106a15:	75 07                	jne    80106a1e <uartgetc+0x33>
    return -1;
80106a17:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a1c:	eb 0f                	jmp    80106a2d <uartgetc+0x42>
  return inb(COM1+0);
80106a1e:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106a25:	e8 24 fe ff ff       	call   8010684e <inb>
80106a2a:	0f b6 c0             	movzbl %al,%eax
}
80106a2d:	c9                   	leave  
80106a2e:	c3                   	ret    
...
80106a35:	c7 04 24 eb 69 10 80 	movl   $0x801069eb,(%esp)
80106a3c:	e8 a8 9d ff ff       	call   801007e9 <consoleintr>
}
80106a41:	c9                   	leave  
80106a42:	c3                   	ret    
...
80106a45:	6a 00                	push   $0x0
  jmp alltraps
80106a47:	e9 a9 f9 ff ff       	jmp    801063f5 <alltraps>
...
80106a4c:	6a 00                	push   $0x0
  pushl $1
80106a4e:	6a 01                	push   $0x1
  jmp alltraps
80106a50:	e9 a0 f9 ff ff       	jmp    801063f5 <alltraps>
...
80106a55:	6a 00                	push   $0x0
  pushl $2
80106a57:	6a 02                	push   $0x2
  jmp alltraps
80106a59:	e9 97 f9 ff ff       	jmp    801063f5 <alltraps>
...
80106a5e:	6a 00                	push   $0x0
  pushl $3
80106a60:	6a 03                	push   $0x3
  jmp alltraps
80106a62:	e9 8e f9 ff ff       	jmp    801063f5 <alltraps>
...
80106a67:	6a 00                	push   $0x0
  pushl $4
80106a69:	6a 04                	push   $0x4
  jmp alltraps
80106a6b:	e9 85 f9 ff ff       	jmp    801063f5 <alltraps>
...
80106a70:	6a 00                	push   $0x0
  pushl $5
80106a72:	6a 05                	push   $0x5
  jmp alltraps
80106a74:	e9 7c f9 ff ff       	jmp    801063f5 <alltraps>
...
80106a79:	6a 00                	push   $0x0
  pushl $6
80106a7b:	6a 06                	push   $0x6
  jmp alltraps
80106a7d:	e9 73 f9 ff ff       	jmp    801063f5 <alltraps>
...
80106a82:	6a 00                	push   $0x0
  pushl $7
80106a84:	6a 07                	push   $0x7
  jmp alltraps
80106a86:	e9 6a f9 ff ff       	jmp    801063f5 <alltraps>

80106a8b <vector8>:
.globl vector8
vector8:
  pushl $8
80106a8b:	6a 08                	push   $0x8
  jmp alltraps
80106a8d:	e9 63 f9 ff ff       	jmp    801063f5 <alltraps>
...
80106a92:	6a 00                	push   $0x0
  pushl $9
80106a94:	6a 09                	push   $0x9
  jmp alltraps
80106a96:	e9 5a f9 ff ff       	jmp    801063f5 <alltraps>

80106a9b <vector10>:
.globl vector10
vector10:
  pushl $10
80106a9b:	6a 0a                	push   $0xa
  jmp alltraps
80106a9d:	e9 53 f9 ff ff       	jmp    801063f5 <alltraps>

80106aa2 <vector11>:
.globl vector11
vector11:
  pushl $11
80106aa2:	6a 0b                	push   $0xb
  jmp alltraps
80106aa4:	e9 4c f9 ff ff       	jmp    801063f5 <alltraps>

80106aa9 <vector12>:
.globl vector12
vector12:
  pushl $12
80106aa9:	6a 0c                	push   $0xc
  jmp alltraps
80106aab:	e9 45 f9 ff ff       	jmp    801063f5 <alltraps>

80106ab0 <vector13>:
.globl vector13
vector13:
  pushl $13
80106ab0:	6a 0d                	push   $0xd
  jmp alltraps
80106ab2:	e9 3e f9 ff ff       	jmp    801063f5 <alltraps>

80106ab7 <vector14>:
.globl vector14
vector14:
  pushl $14
80106ab7:	6a 0e                	push   $0xe
  jmp alltraps
80106ab9:	e9 37 f9 ff ff       	jmp    801063f5 <alltraps>
...
80106abe:	6a 00                	push   $0x0
  pushl $15
80106ac0:	6a 0f                	push   $0xf
  jmp alltraps
80106ac2:	e9 2e f9 ff ff       	jmp    801063f5 <alltraps>
...
80106ac7:	6a 00                	push   $0x0
  pushl $16
80106ac9:	6a 10                	push   $0x10
  jmp alltraps
80106acb:	e9 25 f9 ff ff       	jmp    801063f5 <alltraps>

80106ad0 <vector17>:
.globl vector17
vector17:
  pushl $17
80106ad0:	6a 11                	push   $0x11
  jmp alltraps
80106ad2:	e9 1e f9 ff ff       	jmp    801063f5 <alltraps>
...
80106ad7:	6a 00                	push   $0x0
  pushl $18
80106ad9:	6a 12                	push   $0x12
  jmp alltraps
80106adb:	e9 15 f9 ff ff       	jmp    801063f5 <alltraps>
...
80106ae0:	6a 00                	push   $0x0
  pushl $19
80106ae2:	6a 13                	push   $0x13
  jmp alltraps
80106ae4:	e9 0c f9 ff ff       	jmp    801063f5 <alltraps>
...
80106ae9:	6a 00                	push   $0x0
  pushl $20
80106aeb:	6a 14                	push   $0x14
  jmp alltraps
80106aed:	e9 03 f9 ff ff       	jmp    801063f5 <alltraps>
...
80106af2:	6a 00                	push   $0x0
  pushl $21
80106af4:	6a 15                	push   $0x15
  jmp alltraps
80106af6:	e9 fa f8 ff ff       	jmp    801063f5 <alltraps>
...
80106afb:	6a 00                	push   $0x0
  pushl $22
80106afd:	6a 16                	push   $0x16
  jmp alltraps
80106aff:	e9 f1 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b04:	6a 00                	push   $0x0
  pushl $23
80106b06:	6a 17                	push   $0x17
  jmp alltraps
80106b08:	e9 e8 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b0d:	6a 00                	push   $0x0
  pushl $24
80106b0f:	6a 18                	push   $0x18
  jmp alltraps
80106b11:	e9 df f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b16:	6a 00                	push   $0x0
  pushl $25
80106b18:	6a 19                	push   $0x19
  jmp alltraps
80106b1a:	e9 d6 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b1f:	6a 00                	push   $0x0
  pushl $26
80106b21:	6a 1a                	push   $0x1a
  jmp alltraps
80106b23:	e9 cd f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b28:	6a 00                	push   $0x0
  pushl $27
80106b2a:	6a 1b                	push   $0x1b
  jmp alltraps
80106b2c:	e9 c4 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b31:	6a 00                	push   $0x0
  pushl $28
80106b33:	6a 1c                	push   $0x1c
  jmp alltraps
80106b35:	e9 bb f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b3a:	6a 00                	push   $0x0
  pushl $29
80106b3c:	6a 1d                	push   $0x1d
  jmp alltraps
80106b3e:	e9 b2 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b43:	6a 00                	push   $0x0
  pushl $30
80106b45:	6a 1e                	push   $0x1e
  jmp alltraps
80106b47:	e9 a9 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b4c:	6a 00                	push   $0x0
  pushl $31
80106b4e:	6a 1f                	push   $0x1f
  jmp alltraps
80106b50:	e9 a0 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b55:	6a 00                	push   $0x0
  pushl $32
80106b57:	6a 20                	push   $0x20
  jmp alltraps
80106b59:	e9 97 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b5e:	6a 00                	push   $0x0
  pushl $33
80106b60:	6a 21                	push   $0x21
  jmp alltraps
80106b62:	e9 8e f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b67:	6a 00                	push   $0x0
  pushl $34
80106b69:	6a 22                	push   $0x22
  jmp alltraps
80106b6b:	e9 85 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b70:	6a 00                	push   $0x0
  pushl $35
80106b72:	6a 23                	push   $0x23
  jmp alltraps
80106b74:	e9 7c f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b79:	6a 00                	push   $0x0
  pushl $36
80106b7b:	6a 24                	push   $0x24
  jmp alltraps
80106b7d:	e9 73 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b82:	6a 00                	push   $0x0
  pushl $37
80106b84:	6a 25                	push   $0x25
  jmp alltraps
80106b86:	e9 6a f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b8b:	6a 00                	push   $0x0
  pushl $38
80106b8d:	6a 26                	push   $0x26
  jmp alltraps
80106b8f:	e9 61 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b94:	6a 00                	push   $0x0
  pushl $39
80106b96:	6a 27                	push   $0x27
  jmp alltraps
80106b98:	e9 58 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106b9d:	6a 00                	push   $0x0
  pushl $40
80106b9f:	6a 28                	push   $0x28
  jmp alltraps
80106ba1:	e9 4f f8 ff ff       	jmp    801063f5 <alltraps>
...
80106ba6:	6a 00                	push   $0x0
  pushl $41
80106ba8:	6a 29                	push   $0x29
  jmp alltraps
80106baa:	e9 46 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106baf:	6a 00                	push   $0x0
  pushl $42
80106bb1:	6a 2a                	push   $0x2a
  jmp alltraps
80106bb3:	e9 3d f8 ff ff       	jmp    801063f5 <alltraps>
...
80106bb8:	6a 00                	push   $0x0
  pushl $43
80106bba:	6a 2b                	push   $0x2b
  jmp alltraps
80106bbc:	e9 34 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106bc1:	6a 00                	push   $0x0
  pushl $44
80106bc3:	6a 2c                	push   $0x2c
  jmp alltraps
80106bc5:	e9 2b f8 ff ff       	jmp    801063f5 <alltraps>
...
80106bca:	6a 00                	push   $0x0
  pushl $45
80106bcc:	6a 2d                	push   $0x2d
  jmp alltraps
80106bce:	e9 22 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106bd3:	6a 00                	push   $0x0
  pushl $46
80106bd5:	6a 2e                	push   $0x2e
  jmp alltraps
80106bd7:	e9 19 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106bdc:	6a 00                	push   $0x0
  pushl $47
80106bde:	6a 2f                	push   $0x2f
  jmp alltraps
80106be0:	e9 10 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106be5:	6a 00                	push   $0x0
  pushl $48
80106be7:	6a 30                	push   $0x30
  jmp alltraps
80106be9:	e9 07 f8 ff ff       	jmp    801063f5 <alltraps>
...
80106bee:	6a 00                	push   $0x0
  pushl $49
80106bf0:	6a 31                	push   $0x31
  jmp alltraps
80106bf2:	e9 fe f7 ff ff       	jmp    801063f5 <alltraps>
...
80106bf7:	6a 00                	push   $0x0
  pushl $50
80106bf9:	6a 32                	push   $0x32
  jmp alltraps
80106bfb:	e9 f5 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c00:	6a 00                	push   $0x0
  pushl $51
80106c02:	6a 33                	push   $0x33
  jmp alltraps
80106c04:	e9 ec f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c09:	6a 00                	push   $0x0
  pushl $52
80106c0b:	6a 34                	push   $0x34
  jmp alltraps
80106c0d:	e9 e3 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c12:	6a 00                	push   $0x0
  pushl $53
80106c14:	6a 35                	push   $0x35
  jmp alltraps
80106c16:	e9 da f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c1b:	6a 00                	push   $0x0
  pushl $54
80106c1d:	6a 36                	push   $0x36
  jmp alltraps
80106c1f:	e9 d1 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c24:	6a 00                	push   $0x0
  pushl $55
80106c26:	6a 37                	push   $0x37
  jmp alltraps
80106c28:	e9 c8 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c2d:	6a 00                	push   $0x0
  pushl $56
80106c2f:	6a 38                	push   $0x38
  jmp alltraps
80106c31:	e9 bf f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c36:	6a 00                	push   $0x0
  pushl $57
80106c38:	6a 39                	push   $0x39
  jmp alltraps
80106c3a:	e9 b6 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c3f:	6a 00                	push   $0x0
  pushl $58
80106c41:	6a 3a                	push   $0x3a
  jmp alltraps
80106c43:	e9 ad f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c48:	6a 00                	push   $0x0
  pushl $59
80106c4a:	6a 3b                	push   $0x3b
  jmp alltraps
80106c4c:	e9 a4 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c51:	6a 00                	push   $0x0
  pushl $60
80106c53:	6a 3c                	push   $0x3c
  jmp alltraps
80106c55:	e9 9b f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c5a:	6a 00                	push   $0x0
  pushl $61
80106c5c:	6a 3d                	push   $0x3d
  jmp alltraps
80106c5e:	e9 92 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c63:	6a 00                	push   $0x0
  pushl $62
80106c65:	6a 3e                	push   $0x3e
  jmp alltraps
80106c67:	e9 89 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c6c:	6a 00                	push   $0x0
  pushl $63
80106c6e:	6a 3f                	push   $0x3f
  jmp alltraps
80106c70:	e9 80 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c75:	6a 00                	push   $0x0
  pushl $64
80106c77:	6a 40                	push   $0x40
  jmp alltraps
80106c79:	e9 77 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c7e:	6a 00                	push   $0x0
  pushl $65
80106c80:	6a 41                	push   $0x41
  jmp alltraps
80106c82:	e9 6e f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c87:	6a 00                	push   $0x0
  pushl $66
80106c89:	6a 42                	push   $0x42
  jmp alltraps
80106c8b:	e9 65 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c90:	6a 00                	push   $0x0
  pushl $67
80106c92:	6a 43                	push   $0x43
  jmp alltraps
80106c94:	e9 5c f7 ff ff       	jmp    801063f5 <alltraps>
...
80106c99:	6a 00                	push   $0x0
  pushl $68
80106c9b:	6a 44                	push   $0x44
  jmp alltraps
80106c9d:	e9 53 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106ca2:	6a 00                	push   $0x0
  pushl $69
80106ca4:	6a 45                	push   $0x45
  jmp alltraps
80106ca6:	e9 4a f7 ff ff       	jmp    801063f5 <alltraps>
...
80106cab:	6a 00                	push   $0x0
  pushl $70
80106cad:	6a 46                	push   $0x46
  jmp alltraps
80106caf:	e9 41 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106cb4:	6a 00                	push   $0x0
  pushl $71
80106cb6:	6a 47                	push   $0x47
  jmp alltraps
80106cb8:	e9 38 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106cbd:	6a 00                	push   $0x0
  pushl $72
80106cbf:	6a 48                	push   $0x48
  jmp alltraps
80106cc1:	e9 2f f7 ff ff       	jmp    801063f5 <alltraps>
...
80106cc6:	6a 00                	push   $0x0
  pushl $73
80106cc8:	6a 49                	push   $0x49
  jmp alltraps
80106cca:	e9 26 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106ccf:	6a 00                	push   $0x0
  pushl $74
80106cd1:	6a 4a                	push   $0x4a
  jmp alltraps
80106cd3:	e9 1d f7 ff ff       	jmp    801063f5 <alltraps>
...
80106cd8:	6a 00                	push   $0x0
  pushl $75
80106cda:	6a 4b                	push   $0x4b
  jmp alltraps
80106cdc:	e9 14 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106ce1:	6a 00                	push   $0x0
  pushl $76
80106ce3:	6a 4c                	push   $0x4c
  jmp alltraps
80106ce5:	e9 0b f7 ff ff       	jmp    801063f5 <alltraps>
...
80106cea:	6a 00                	push   $0x0
  pushl $77
80106cec:	6a 4d                	push   $0x4d
  jmp alltraps
80106cee:	e9 02 f7 ff ff       	jmp    801063f5 <alltraps>
...
80106cf3:	6a 00                	push   $0x0
  pushl $78
80106cf5:	6a 4e                	push   $0x4e
  jmp alltraps
80106cf7:	e9 f9 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106cfc:	6a 00                	push   $0x0
  pushl $79
80106cfe:	6a 4f                	push   $0x4f
  jmp alltraps
80106d00:	e9 f0 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d05:	6a 00                	push   $0x0
  pushl $80
80106d07:	6a 50                	push   $0x50
  jmp alltraps
80106d09:	e9 e7 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d0e:	6a 00                	push   $0x0
  pushl $81
80106d10:	6a 51                	push   $0x51
  jmp alltraps
80106d12:	e9 de f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d17:	6a 00                	push   $0x0
  pushl $82
80106d19:	6a 52                	push   $0x52
  jmp alltraps
80106d1b:	e9 d5 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d20:	6a 00                	push   $0x0
  pushl $83
80106d22:	6a 53                	push   $0x53
  jmp alltraps
80106d24:	e9 cc f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d29:	6a 00                	push   $0x0
  pushl $84
80106d2b:	6a 54                	push   $0x54
  jmp alltraps
80106d2d:	e9 c3 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d32:	6a 00                	push   $0x0
  pushl $85
80106d34:	6a 55                	push   $0x55
  jmp alltraps
80106d36:	e9 ba f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d3b:	6a 00                	push   $0x0
  pushl $86
80106d3d:	6a 56                	push   $0x56
  jmp alltraps
80106d3f:	e9 b1 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d44:	6a 00                	push   $0x0
  pushl $87
80106d46:	6a 57                	push   $0x57
  jmp alltraps
80106d48:	e9 a8 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d4d:	6a 00                	push   $0x0
  pushl $88
80106d4f:	6a 58                	push   $0x58
  jmp alltraps
80106d51:	e9 9f f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d56:	6a 00                	push   $0x0
  pushl $89
80106d58:	6a 59                	push   $0x59
  jmp alltraps
80106d5a:	e9 96 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d5f:	6a 00                	push   $0x0
  pushl $90
80106d61:	6a 5a                	push   $0x5a
  jmp alltraps
80106d63:	e9 8d f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d68:	6a 00                	push   $0x0
  pushl $91
80106d6a:	6a 5b                	push   $0x5b
  jmp alltraps
80106d6c:	e9 84 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d71:	6a 00                	push   $0x0
  pushl $92
80106d73:	6a 5c                	push   $0x5c
  jmp alltraps
80106d75:	e9 7b f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d7a:	6a 00                	push   $0x0
  pushl $93
80106d7c:	6a 5d                	push   $0x5d
  jmp alltraps
80106d7e:	e9 72 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d83:	6a 00                	push   $0x0
  pushl $94
80106d85:	6a 5e                	push   $0x5e
  jmp alltraps
80106d87:	e9 69 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d8c:	6a 00                	push   $0x0
  pushl $95
80106d8e:	6a 5f                	push   $0x5f
  jmp alltraps
80106d90:	e9 60 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d95:	6a 00                	push   $0x0
  pushl $96
80106d97:	6a 60                	push   $0x60
  jmp alltraps
80106d99:	e9 57 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106d9e:	6a 00                	push   $0x0
  pushl $97
80106da0:	6a 61                	push   $0x61
  jmp alltraps
80106da2:	e9 4e f6 ff ff       	jmp    801063f5 <alltraps>
...
80106da7:	6a 00                	push   $0x0
  pushl $98
80106da9:	6a 62                	push   $0x62
  jmp alltraps
80106dab:	e9 45 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106db0:	6a 00                	push   $0x0
  pushl $99
80106db2:	6a 63                	push   $0x63
  jmp alltraps
80106db4:	e9 3c f6 ff ff       	jmp    801063f5 <alltraps>
...
80106db9:	6a 00                	push   $0x0
  pushl $100
80106dbb:	6a 64                	push   $0x64
  jmp alltraps
80106dbd:	e9 33 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106dc2:	6a 00                	push   $0x0
  pushl $101
80106dc4:	6a 65                	push   $0x65
  jmp alltraps
80106dc6:	e9 2a f6 ff ff       	jmp    801063f5 <alltraps>
...
80106dcb:	6a 00                	push   $0x0
  pushl $102
80106dcd:	6a 66                	push   $0x66
  jmp alltraps
80106dcf:	e9 21 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106dd4:	6a 00                	push   $0x0
  pushl $103
80106dd6:	6a 67                	push   $0x67
  jmp alltraps
80106dd8:	e9 18 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106ddd:	6a 00                	push   $0x0
  pushl $104
80106ddf:	6a 68                	push   $0x68
  jmp alltraps
80106de1:	e9 0f f6 ff ff       	jmp    801063f5 <alltraps>
...
80106de6:	6a 00                	push   $0x0
  pushl $105
80106de8:	6a 69                	push   $0x69
  jmp alltraps
80106dea:	e9 06 f6 ff ff       	jmp    801063f5 <alltraps>
...
80106def:	6a 00                	push   $0x0
  pushl $106
80106df1:	6a 6a                	push   $0x6a
  jmp alltraps
80106df3:	e9 fd f5 ff ff       	jmp    801063f5 <alltraps>
...
80106df8:	6a 00                	push   $0x0
  pushl $107
80106dfa:	6a 6b                	push   $0x6b
  jmp alltraps
80106dfc:	e9 f4 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e01:	6a 00                	push   $0x0
  pushl $108
80106e03:	6a 6c                	push   $0x6c
  jmp alltraps
80106e05:	e9 eb f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e0a:	6a 00                	push   $0x0
  pushl $109
80106e0c:	6a 6d                	push   $0x6d
  jmp alltraps
80106e0e:	e9 e2 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e13:	6a 00                	push   $0x0
  pushl $110
80106e15:	6a 6e                	push   $0x6e
  jmp alltraps
80106e17:	e9 d9 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e1c:	6a 00                	push   $0x0
  pushl $111
80106e1e:	6a 6f                	push   $0x6f
  jmp alltraps
80106e20:	e9 d0 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e25:	6a 00                	push   $0x0
  pushl $112
80106e27:	6a 70                	push   $0x70
  jmp alltraps
80106e29:	e9 c7 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e2e:	6a 00                	push   $0x0
  pushl $113
80106e30:	6a 71                	push   $0x71
  jmp alltraps
80106e32:	e9 be f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e37:	6a 00                	push   $0x0
  pushl $114
80106e39:	6a 72                	push   $0x72
  jmp alltraps
80106e3b:	e9 b5 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e40:	6a 00                	push   $0x0
  pushl $115
80106e42:	6a 73                	push   $0x73
  jmp alltraps
80106e44:	e9 ac f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e49:	6a 00                	push   $0x0
  pushl $116
80106e4b:	6a 74                	push   $0x74
  jmp alltraps
80106e4d:	e9 a3 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e52:	6a 00                	push   $0x0
  pushl $117
80106e54:	6a 75                	push   $0x75
  jmp alltraps
80106e56:	e9 9a f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e5b:	6a 00                	push   $0x0
  pushl $118
80106e5d:	6a 76                	push   $0x76
  jmp alltraps
80106e5f:	e9 91 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e64:	6a 00                	push   $0x0
  pushl $119
80106e66:	6a 77                	push   $0x77
  jmp alltraps
80106e68:	e9 88 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e6d:	6a 00                	push   $0x0
  pushl $120
80106e6f:	6a 78                	push   $0x78
  jmp alltraps
80106e71:	e9 7f f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e76:	6a 00                	push   $0x0
  pushl $121
80106e78:	6a 79                	push   $0x79
  jmp alltraps
80106e7a:	e9 76 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e7f:	6a 00                	push   $0x0
  pushl $122
80106e81:	6a 7a                	push   $0x7a
  jmp alltraps
80106e83:	e9 6d f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e88:	6a 00                	push   $0x0
  pushl $123
80106e8a:	6a 7b                	push   $0x7b
  jmp alltraps
80106e8c:	e9 64 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e91:	6a 00                	push   $0x0
  pushl $124
80106e93:	6a 7c                	push   $0x7c
  jmp alltraps
80106e95:	e9 5b f5 ff ff       	jmp    801063f5 <alltraps>
...
80106e9a:	6a 00                	push   $0x0
  pushl $125
80106e9c:	6a 7d                	push   $0x7d
  jmp alltraps
80106e9e:	e9 52 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106ea3:	6a 00                	push   $0x0
  pushl $126
80106ea5:	6a 7e                	push   $0x7e
  jmp alltraps
80106ea7:	e9 49 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106eac:	6a 00                	push   $0x0
  pushl $127
80106eae:	6a 7f                	push   $0x7f
  jmp alltraps
80106eb0:	e9 40 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106eb5:	6a 00                	push   $0x0
  pushl $128
80106eb7:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106ebc:	e9 34 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106ec1:	6a 00                	push   $0x0
  pushl $129
80106ec3:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106ec8:	e9 28 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106ecd:	6a 00                	push   $0x0
  pushl $130
80106ecf:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106ed4:	e9 1c f5 ff ff       	jmp    801063f5 <alltraps>
...
80106ed9:	6a 00                	push   $0x0
  pushl $131
80106edb:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106ee0:	e9 10 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106ee5:	6a 00                	push   $0x0
  pushl $132
80106ee7:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106eec:	e9 04 f5 ff ff       	jmp    801063f5 <alltraps>
...
80106ef1:	6a 00                	push   $0x0
  pushl $133
80106ef3:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106ef8:	e9 f8 f4 ff ff       	jmp    801063f5 <alltraps>
...
80106efd:	6a 00                	push   $0x0
  pushl $134
80106eff:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106f04:	e9 ec f4 ff ff       	jmp    801063f5 <alltraps>
...
80106f09:	6a 00                	push   $0x0
  pushl $135
80106f0b:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106f10:	e9 e0 f4 ff ff       	jmp    801063f5 <alltraps>
...
80106f15:	6a 00                	push   $0x0
  pushl $136
80106f17:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106f1c:	e9 d4 f4 ff ff       	jmp    801063f5 <alltraps>
...
80106f21:	6a 00                	push   $0x0
  pushl $137
80106f23:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106f28:	e9 c8 f4 ff ff       	jmp    801063f5 <alltraps>
...
80106f2d:	6a 00                	push   $0x0
  pushl $138
80106f2f:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106f34:	e9 bc f4 ff ff       	jmp    801063f5 <alltraps>
...
80106f39:	6a 00                	push   $0x0
  pushl $139
80106f3b:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106f40:	e9 b0 f4 ff ff       	jmp    801063f5 <alltraps>
...
80106f45:	6a 00                	push   $0x0
  pushl $140
80106f47:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106f4c:	e9 a4 f4 ff ff       	jmp    801063f5 <alltraps>
...
80106f51:	6a 00                	push   $0x0
  pushl $141
80106f53:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106f58:	e9 98 f4 ff ff       	jmp    801063f5 <alltraps>
...
80106f5d:	6a 00                	push   $0x0
  pushl $142
80106f5f:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106f64:	e9 8c f4 ff ff       	jmp    801063f5 <alltraps>
...
80106f69:	6a 00                	push   $0x0
  pushl $143
80106f6b:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106f70:	e9 80 f4 ff ff       	jmp    801063f5 <alltraps>
...
80106f75:	6a 00                	push   $0x0
  pushl $144
80106f77:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106f7c:	e9 74 f4 ff ff       	jmp    801063f5 <alltraps>
...
80106f81:	6a 00                	push   $0x0
  pushl $145
80106f83:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106f88:	e9 68 f4 ff ff       	jmp    801063f5 <alltraps>
...
80106f8d:	6a 00                	push   $0x0
  pushl $146
80106f8f:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106f94:	e9 5c f4 ff ff       	jmp    801063f5 <alltraps>
...
80106f99:	6a 00                	push   $0x0
  pushl $147
80106f9b:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106fa0:	e9 50 f4 ff ff       	jmp    801063f5 <alltraps>
...
80106fa5:	6a 00                	push   $0x0
  pushl $148
80106fa7:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106fac:	e9 44 f4 ff ff       	jmp    801063f5 <alltraps>
...
80106fb1:	6a 00                	push   $0x0
  pushl $149
80106fb3:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106fb8:	e9 38 f4 ff ff       	jmp    801063f5 <alltraps>
...
80106fbd:	6a 00                	push   $0x0
  pushl $150
80106fbf:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106fc4:	e9 2c f4 ff ff       	jmp    801063f5 <alltraps>
...
80106fc9:	6a 00                	push   $0x0
  pushl $151
80106fcb:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106fd0:	e9 20 f4 ff ff       	jmp    801063f5 <alltraps>
...
80106fd5:	6a 00                	push   $0x0
  pushl $152
80106fd7:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106fdc:	e9 14 f4 ff ff       	jmp    801063f5 <alltraps>
...
80106fe1:	6a 00                	push   $0x0
  pushl $153
80106fe3:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106fe8:	e9 08 f4 ff ff       	jmp    801063f5 <alltraps>
...
80106fed:	6a 00                	push   $0x0
  pushl $154
80106fef:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106ff4:	e9 fc f3 ff ff       	jmp    801063f5 <alltraps>
...
80106ff9:	6a 00                	push   $0x0
  pushl $155
80106ffb:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107000:	e9 f0 f3 ff ff       	jmp    801063f5 <alltraps>
...
80107005:	6a 00                	push   $0x0
  pushl $156
80107007:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010700c:	e9 e4 f3 ff ff       	jmp    801063f5 <alltraps>
...
80107011:	6a 00                	push   $0x0
  pushl $157
80107013:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107018:	e9 d8 f3 ff ff       	jmp    801063f5 <alltraps>
...
8010701d:	6a 00                	push   $0x0
  pushl $158
8010701f:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107024:	e9 cc f3 ff ff       	jmp    801063f5 <alltraps>
...
80107029:	6a 00                	push   $0x0
  pushl $159
8010702b:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107030:	e9 c0 f3 ff ff       	jmp    801063f5 <alltraps>
...
80107035:	6a 00                	push   $0x0
  pushl $160
80107037:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010703c:	e9 b4 f3 ff ff       	jmp    801063f5 <alltraps>
...
80107041:	6a 00                	push   $0x0
  pushl $161
80107043:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107048:	e9 a8 f3 ff ff       	jmp    801063f5 <alltraps>
...
8010704d:	6a 00                	push   $0x0
  pushl $162
8010704f:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107054:	e9 9c f3 ff ff       	jmp    801063f5 <alltraps>
...
80107059:	6a 00                	push   $0x0
  pushl $163
8010705b:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107060:	e9 90 f3 ff ff       	jmp    801063f5 <alltraps>
...
80107065:	6a 00                	push   $0x0
  pushl $164
80107067:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010706c:	e9 84 f3 ff ff       	jmp    801063f5 <alltraps>
...
80107071:	6a 00                	push   $0x0
  pushl $165
80107073:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107078:	e9 78 f3 ff ff       	jmp    801063f5 <alltraps>
...
8010707d:	6a 00                	push   $0x0
  pushl $166
8010707f:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107084:	e9 6c f3 ff ff       	jmp    801063f5 <alltraps>
...
80107089:	6a 00                	push   $0x0
  pushl $167
8010708b:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107090:	e9 60 f3 ff ff       	jmp    801063f5 <alltraps>
...
80107095:	6a 00                	push   $0x0
  pushl $168
80107097:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010709c:	e9 54 f3 ff ff       	jmp    801063f5 <alltraps>
...
801070a1:	6a 00                	push   $0x0
  pushl $169
801070a3:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801070a8:	e9 48 f3 ff ff       	jmp    801063f5 <alltraps>
...
801070ad:	6a 00                	push   $0x0
  pushl $170
801070af:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801070b4:	e9 3c f3 ff ff       	jmp    801063f5 <alltraps>
...
801070b9:	6a 00                	push   $0x0
  pushl $171
801070bb:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801070c0:	e9 30 f3 ff ff       	jmp    801063f5 <alltraps>
...
801070c5:	6a 00                	push   $0x0
  pushl $172
801070c7:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801070cc:	e9 24 f3 ff ff       	jmp    801063f5 <alltraps>
...
801070d1:	6a 00                	push   $0x0
  pushl $173
801070d3:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801070d8:	e9 18 f3 ff ff       	jmp    801063f5 <alltraps>
...
801070dd:	6a 00                	push   $0x0
  pushl $174
801070df:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801070e4:	e9 0c f3 ff ff       	jmp    801063f5 <alltraps>
...
801070e9:	6a 00                	push   $0x0
  pushl $175
801070eb:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801070f0:	e9 00 f3 ff ff       	jmp    801063f5 <alltraps>
...
801070f5:	6a 00                	push   $0x0
  pushl $176
801070f7:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801070fc:	e9 f4 f2 ff ff       	jmp    801063f5 <alltraps>
...
80107101:	6a 00                	push   $0x0
  pushl $177
80107103:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107108:	e9 e8 f2 ff ff       	jmp    801063f5 <alltraps>
...
8010710d:	6a 00                	push   $0x0
  pushl $178
8010710f:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107114:	e9 dc f2 ff ff       	jmp    801063f5 <alltraps>
...
80107119:	6a 00                	push   $0x0
  pushl $179
8010711b:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107120:	e9 d0 f2 ff ff       	jmp    801063f5 <alltraps>
...
80107125:	6a 00                	push   $0x0
  pushl $180
80107127:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010712c:	e9 c4 f2 ff ff       	jmp    801063f5 <alltraps>
...
80107131:	6a 00                	push   $0x0
  pushl $181
80107133:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107138:	e9 b8 f2 ff ff       	jmp    801063f5 <alltraps>
...
8010713d:	6a 00                	push   $0x0
  pushl $182
8010713f:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107144:	e9 ac f2 ff ff       	jmp    801063f5 <alltraps>
...
80107149:	6a 00                	push   $0x0
  pushl $183
8010714b:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107150:	e9 a0 f2 ff ff       	jmp    801063f5 <alltraps>
...
80107155:	6a 00                	push   $0x0
  pushl $184
80107157:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010715c:	e9 94 f2 ff ff       	jmp    801063f5 <alltraps>
...
80107161:	6a 00                	push   $0x0
  pushl $185
80107163:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107168:	e9 88 f2 ff ff       	jmp    801063f5 <alltraps>
...
8010716d:	6a 00                	push   $0x0
  pushl $186
8010716f:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107174:	e9 7c f2 ff ff       	jmp    801063f5 <alltraps>
...
80107179:	6a 00                	push   $0x0
  pushl $187
8010717b:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107180:	e9 70 f2 ff ff       	jmp    801063f5 <alltraps>
...
80107185:	6a 00                	push   $0x0
  pushl $188
80107187:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010718c:	e9 64 f2 ff ff       	jmp    801063f5 <alltraps>
...
80107191:	6a 00                	push   $0x0
  pushl $189
80107193:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107198:	e9 58 f2 ff ff       	jmp    801063f5 <alltraps>
...
8010719d:	6a 00                	push   $0x0
  pushl $190
8010719f:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801071a4:	e9 4c f2 ff ff       	jmp    801063f5 <alltraps>
...
801071a9:	6a 00                	push   $0x0
  pushl $191
801071ab:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801071b0:	e9 40 f2 ff ff       	jmp    801063f5 <alltraps>
...
801071b5:	6a 00                	push   $0x0
  pushl $192
801071b7:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801071bc:	e9 34 f2 ff ff       	jmp    801063f5 <alltraps>
...
801071c1:	6a 00                	push   $0x0
  pushl $193
801071c3:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801071c8:	e9 28 f2 ff ff       	jmp    801063f5 <alltraps>
...
801071cd:	6a 00                	push   $0x0
  pushl $194
801071cf:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801071d4:	e9 1c f2 ff ff       	jmp    801063f5 <alltraps>
...
801071d9:	6a 00                	push   $0x0
  pushl $195
801071db:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801071e0:	e9 10 f2 ff ff       	jmp    801063f5 <alltraps>
...
801071e5:	6a 00                	push   $0x0
  pushl $196
801071e7:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801071ec:	e9 04 f2 ff ff       	jmp    801063f5 <alltraps>
...
801071f1:	6a 00                	push   $0x0
  pushl $197
801071f3:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801071f8:	e9 f8 f1 ff ff       	jmp    801063f5 <alltraps>
...
801071fd:	6a 00                	push   $0x0
  pushl $198
801071ff:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107204:	e9 ec f1 ff ff       	jmp    801063f5 <alltraps>
...
80107209:	6a 00                	push   $0x0
  pushl $199
8010720b:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107210:	e9 e0 f1 ff ff       	jmp    801063f5 <alltraps>
...
80107215:	6a 00                	push   $0x0
  pushl $200
80107217:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010721c:	e9 d4 f1 ff ff       	jmp    801063f5 <alltraps>
...
80107221:	6a 00                	push   $0x0
  pushl $201
80107223:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107228:	e9 c8 f1 ff ff       	jmp    801063f5 <alltraps>
...
8010722d:	6a 00                	push   $0x0
  pushl $202
8010722f:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107234:	e9 bc f1 ff ff       	jmp    801063f5 <alltraps>
...
80107239:	6a 00                	push   $0x0
  pushl $203
8010723b:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107240:	e9 b0 f1 ff ff       	jmp    801063f5 <alltraps>
...
80107245:	6a 00                	push   $0x0
  pushl $204
80107247:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010724c:	e9 a4 f1 ff ff       	jmp    801063f5 <alltraps>
...
80107251:	6a 00                	push   $0x0
  pushl $205
80107253:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107258:	e9 98 f1 ff ff       	jmp    801063f5 <alltraps>
...
8010725d:	6a 00                	push   $0x0
  pushl $206
8010725f:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107264:	e9 8c f1 ff ff       	jmp    801063f5 <alltraps>
...
80107269:	6a 00                	push   $0x0
  pushl $207
8010726b:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107270:	e9 80 f1 ff ff       	jmp    801063f5 <alltraps>
...
80107275:	6a 00                	push   $0x0
  pushl $208
80107277:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010727c:	e9 74 f1 ff ff       	jmp    801063f5 <alltraps>
...
80107281:	6a 00                	push   $0x0
  pushl $209
80107283:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107288:	e9 68 f1 ff ff       	jmp    801063f5 <alltraps>
...
8010728d:	6a 00                	push   $0x0
  pushl $210
8010728f:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107294:	e9 5c f1 ff ff       	jmp    801063f5 <alltraps>
...
80107299:	6a 00                	push   $0x0
  pushl $211
8010729b:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801072a0:	e9 50 f1 ff ff       	jmp    801063f5 <alltraps>
...
801072a5:	6a 00                	push   $0x0
  pushl $212
801072a7:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801072ac:	e9 44 f1 ff ff       	jmp    801063f5 <alltraps>
...
801072b1:	6a 00                	push   $0x0
  pushl $213
801072b3:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801072b8:	e9 38 f1 ff ff       	jmp    801063f5 <alltraps>
...
801072bd:	6a 00                	push   $0x0
  pushl $214
801072bf:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801072c4:	e9 2c f1 ff ff       	jmp    801063f5 <alltraps>
...
801072c9:	6a 00                	push   $0x0
  pushl $215
801072cb:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801072d0:	e9 20 f1 ff ff       	jmp    801063f5 <alltraps>
...
801072d5:	6a 00                	push   $0x0
  pushl $216
801072d7:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801072dc:	e9 14 f1 ff ff       	jmp    801063f5 <alltraps>
...
801072e1:	6a 00                	push   $0x0
  pushl $217
801072e3:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801072e8:	e9 08 f1 ff ff       	jmp    801063f5 <alltraps>
...
801072ed:	6a 00                	push   $0x0
  pushl $218
801072ef:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801072f4:	e9 fc f0 ff ff       	jmp    801063f5 <alltraps>
...
801072f9:	6a 00                	push   $0x0
  pushl $219
801072fb:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107300:	e9 f0 f0 ff ff       	jmp    801063f5 <alltraps>
...
80107305:	6a 00                	push   $0x0
  pushl $220
80107307:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010730c:	e9 e4 f0 ff ff       	jmp    801063f5 <alltraps>
...
80107311:	6a 00                	push   $0x0
  pushl $221
80107313:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107318:	e9 d8 f0 ff ff       	jmp    801063f5 <alltraps>
...
8010731d:	6a 00                	push   $0x0
  pushl $222
8010731f:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107324:	e9 cc f0 ff ff       	jmp    801063f5 <alltraps>
...
80107329:	6a 00                	push   $0x0
  pushl $223
8010732b:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107330:	e9 c0 f0 ff ff       	jmp    801063f5 <alltraps>
...
80107335:	6a 00                	push   $0x0
  pushl $224
80107337:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010733c:	e9 b4 f0 ff ff       	jmp    801063f5 <alltraps>
...
80107341:	6a 00                	push   $0x0
  pushl $225
80107343:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107348:	e9 a8 f0 ff ff       	jmp    801063f5 <alltraps>
...
8010734d:	6a 00                	push   $0x0
  pushl $226
8010734f:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107354:	e9 9c f0 ff ff       	jmp    801063f5 <alltraps>
...
80107359:	6a 00                	push   $0x0
  pushl $227
8010735b:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107360:	e9 90 f0 ff ff       	jmp    801063f5 <alltraps>
...
80107365:	6a 00                	push   $0x0
  pushl $228
80107367:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010736c:	e9 84 f0 ff ff       	jmp    801063f5 <alltraps>
...
80107371:	6a 00                	push   $0x0
  pushl $229
80107373:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107378:	e9 78 f0 ff ff       	jmp    801063f5 <alltraps>
...
8010737d:	6a 00                	push   $0x0
  pushl $230
8010737f:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107384:	e9 6c f0 ff ff       	jmp    801063f5 <alltraps>
...
80107389:	6a 00                	push   $0x0
  pushl $231
8010738b:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107390:	e9 60 f0 ff ff       	jmp    801063f5 <alltraps>
...
80107395:	6a 00                	push   $0x0
  pushl $232
80107397:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010739c:	e9 54 f0 ff ff       	jmp    801063f5 <alltraps>
...
801073a1:	6a 00                	push   $0x0
  pushl $233
801073a3:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801073a8:	e9 48 f0 ff ff       	jmp    801063f5 <alltraps>
...
801073ad:	6a 00                	push   $0x0
  pushl $234
801073af:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801073b4:	e9 3c f0 ff ff       	jmp    801063f5 <alltraps>
...
801073b9:	6a 00                	push   $0x0
  pushl $235
801073bb:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801073c0:	e9 30 f0 ff ff       	jmp    801063f5 <alltraps>
...
801073c5:	6a 00                	push   $0x0
  pushl $236
801073c7:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801073cc:	e9 24 f0 ff ff       	jmp    801063f5 <alltraps>
...
801073d1:	6a 00                	push   $0x0
  pushl $237
801073d3:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801073d8:	e9 18 f0 ff ff       	jmp    801063f5 <alltraps>
...
801073dd:	6a 00                	push   $0x0
  pushl $238
801073df:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801073e4:	e9 0c f0 ff ff       	jmp    801063f5 <alltraps>
...
801073e9:	6a 00                	push   $0x0
  pushl $239
801073eb:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801073f0:	e9 00 f0 ff ff       	jmp    801063f5 <alltraps>
...
801073f5:	6a 00                	push   $0x0
  pushl $240
801073f7:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801073fc:	e9 f4 ef ff ff       	jmp    801063f5 <alltraps>
...
80107401:	6a 00                	push   $0x0
  pushl $241
80107403:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107408:	e9 e8 ef ff ff       	jmp    801063f5 <alltraps>
...
8010740d:	6a 00                	push   $0x0
  pushl $242
8010740f:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107414:	e9 dc ef ff ff       	jmp    801063f5 <alltraps>
...
80107419:	6a 00                	push   $0x0
  pushl $243
8010741b:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107420:	e9 d0 ef ff ff       	jmp    801063f5 <alltraps>
...
80107425:	6a 00                	push   $0x0
  pushl $244
80107427:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010742c:	e9 c4 ef ff ff       	jmp    801063f5 <alltraps>
...
80107431:	6a 00                	push   $0x0
  pushl $245
80107433:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107438:	e9 b8 ef ff ff       	jmp    801063f5 <alltraps>
...
8010743d:	6a 00                	push   $0x0
  pushl $246
8010743f:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107444:	e9 ac ef ff ff       	jmp    801063f5 <alltraps>
...
80107449:	6a 00                	push   $0x0
  pushl $247
8010744b:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107450:	e9 a0 ef ff ff       	jmp    801063f5 <alltraps>
...
80107455:	6a 00                	push   $0x0
  pushl $248
80107457:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010745c:	e9 94 ef ff ff       	jmp    801063f5 <alltraps>
...
80107461:	6a 00                	push   $0x0
  pushl $249
80107463:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107468:	e9 88 ef ff ff       	jmp    801063f5 <alltraps>
...
8010746d:	6a 00                	push   $0x0
  pushl $250
8010746f:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107474:	e9 7c ef ff ff       	jmp    801063f5 <alltraps>
...
80107479:	6a 00                	push   $0x0
  pushl $251
8010747b:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107480:	e9 70 ef ff ff       	jmp    801063f5 <alltraps>
...
80107485:	6a 00                	push   $0x0
  pushl $252
80107487:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010748c:	e9 64 ef ff ff       	jmp    801063f5 <alltraps>
...
80107491:	6a 00                	push   $0x0
  pushl $253
80107493:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107498:	e9 58 ef ff ff       	jmp    801063f5 <alltraps>
...
8010749d:	6a 00                	push   $0x0
  pushl $254
8010749f:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801074a4:	e9 4c ef ff ff       	jmp    801063f5 <alltraps>
...
801074a9:	6a 00                	push   $0x0
  pushl $255
801074ab:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801074b0:	e9 40 ef ff ff       	jmp    801063f5 <alltraps>

801074b5 <lgdt>:
{
801074b5:	55                   	push   %ebp
801074b6:	89 e5                	mov    %esp,%ebp
801074b8:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
801074bb:	8b 45 0c             	mov    0xc(%ebp),%eax
801074be:	83 e8 01             	sub    $0x1,%eax
801074c1:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801074c5:	8b 45 08             	mov    0x8(%ebp),%eax
801074c8:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801074cc:	8b 45 08             	mov    0x8(%ebp),%eax
801074cf:	c1 e8 10             	shr    $0x10,%eax
801074d2:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
801074d6:	8d 45 fa             	lea    -0x6(%ebp),%eax
801074d9:	0f 01 10             	lgdtl  (%eax)
}
801074dc:	c9                   	leave  
801074dd:	c3                   	ret    
...
801074e1:	83 ec 04             	sub    $0x4,%esp
801074e4:	8b 45 08             	mov    0x8(%ebp),%eax
801074e7:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
801074eb:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
801074ef:	0f 00 d8             	ltr    %ax
}
801074f2:	c9                   	leave  
801074f3:	c3                   	ret    
...
80107502:	83 ec 28             	sub    $0x28,%esp
  ...
  c = &cpus[cpuid()];
80107505:	e8 c0 cb ff ff       	call   801040ca <cpuid>
8010750a:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80107510:	05 00 38 11 80       	add    $0x80113800,%eax
80107515:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107518:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010751b:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107521:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107524:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
8010752a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010752d:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107531:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107534:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107538:	83 e2 f0             	and    $0xfffffff0,%edx
8010753b:	83 ca 0a             	or     $0xa,%edx
8010753e:	88 50 7d             	mov    %dl,0x7d(%eax)
80107541:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107544:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107548:	83 ca 10             	or     $0x10,%edx
8010754b:	88 50 7d             	mov    %dl,0x7d(%eax)
8010754e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107551:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107555:	83 e2 9f             	and    $0xffffff9f,%edx
...
801075ac:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801075b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075b3:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
801075ba:	ff ff 
801075bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075bf:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
801075c6:	00 00 
801075c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075cb:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
801075d2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075d5:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801075dc:	83 e2 f0             	and    $0xfffffff0,%edx
801075df:	83 ca 02             	or     $0x2,%edx
801075e2:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801075e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075eb:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801075f2:	83 ca 10             	or     $0x10,%edx
...
80107618:	83 ca 80             	or     $0xffffff80,%edx
...
80107651:	83 e2 df             	and    $0xffffffdf,%edx
...
80107683:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010768a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010768d:	66 c7 80 88 00 00 00 	movw   $0xffff,0x88(%eax)
80107694:	ff ff 
80107696:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107699:	66 c7 80 8a 00 00 00 	movw   $0x0,0x8a(%eax)
801076a0:	00 00 
801076a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076a5:	c6 80 8c 00 00 00 00 	movb   $0x0,0x8c(%eax)
801076ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076af:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801076b6:	83 e2 f0             	and    $0xfffffff0,%edx
801076b9:	83 ca 0a             	or     $0xa,%edx
...
801076cf:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801076d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076d8:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801076df:	83 ca 60             	or     $0x60,%edx
801076e2:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801076e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076eb:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
...
80107718:	83 e2 ef             	and    $0xffffffef,%edx
8010771b:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107721:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107724:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
8010772b:	83 e2 df             	and    $0xffffffdf,%edx
8010772e:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107734:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107737:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
8010773e:	83 ca 40             	or     $0x40,%edx
80107741:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107747:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010774a:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107751:	83 ca 80             	or     $0xffffff80,%edx
80107754:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
8010775a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010775d:	c6 80 8f 00 00 00 00 	movb   $0x0,0x8f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107764:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107767:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
8010776e:	ff ff 
80107770:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107773:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
8010777a:	00 00 
8010777c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010777f:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80107786:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107789:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107790:	83 e2 f0             	and    $0xfffffff0,%edx
80107793:	83 ca 02             	or     $0x2,%edx
...
801077f2:	83 e2 ef             	and    $0xffffffef,%edx
...
80107818:	83 ca 40             	or     $0x40,%edx
8010781b:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107821:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107824:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010782b:	83 ca 80             	or     $0xffffff80,%edx
8010782e:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107834:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107837:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
8010783e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107841:	83 c0 70             	add    $0x70,%eax
80107844:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
8010784b:	00 
8010784c:	89 04 24             	mov    %eax,(%esp)
8010784f:	e8 61 fc ff ff       	call   801074b5 <lgdt>
}
80107854:	c9                   	leave  
80107855:	c3                   	ret    
...
80107859:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
8010785c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010785f:	c1 e8 16             	shr    $0x16,%eax
80107862:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107869:	8b 45 08             	mov    0x8(%ebp),%eax
8010786c:	01 d0                	add    %edx,%eax
8010786e:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80107871:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107874:	8b 00                	mov    (%eax),%eax
80107876:	83 e0 01             	and    $0x1,%eax
80107879:	85 c0                	test   %eax,%eax
8010787b:	74 14                	je     80107891 <walkpgdir+0x3b>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010787d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107880:	8b 00                	mov    (%eax),%eax
80107882:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107887:	05 00 00 00 80       	add    $0x80000000,%eax
8010788c:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010788f:	eb 48                	jmp    801078d9 <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107891:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107895:	74 0e                	je     801078a5 <walkpgdir+0x4f>
80107897:	e8 0d b3 ff ff       	call   80102ba9 <kalloc>
8010789c:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010789f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801078a3:	75 07                	jne    801078ac <walkpgdir+0x56>
      return 0;
801078a5:	b8 00 00 00 00       	mov    $0x0,%eax
801078aa:	eb 44                	jmp    801078f0 <walkpgdir+0x9a>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
801078ac:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801078b3:	00 
801078b4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801078bb:	00 
801078bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078bf:	89 04 24             	mov    %eax,(%esp)
801078c2:	e8 43 d7 ff ff       	call   8010500a <memset>
...
801078f5:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
...
80107916:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
8010791d:	00 
8010791e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107921:	89 44 24 04          	mov    %eax,0x4(%esp)
80107925:	8b 45 08             	mov    0x8(%ebp),%eax
80107928:	89 04 24             	mov    %eax,(%esp)
8010792b:	e8 26 ff ff ff       	call   80107856 <walkpgdir>
80107930:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107933:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107937:	75 07                	jne    80107940 <mappages+0x4e>
      return -1;
80107939:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010793e:	eb 48                	jmp    80107988 <mappages+0x96>
    if(*pte & PTE_P)
80107940:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107943:	8b 00                	mov    (%eax),%eax
80107945:	83 e0 01             	and    $0x1,%eax
80107948:	85 c0                	test   %eax,%eax
8010794a:	74 0c                	je     80107958 <mappages+0x66>
      panic("remap");
8010794c:	c7 04 24 78 88 10 80 	movl   $0x80108878,(%esp)
80107953:	e8 0a 8c ff ff       	call   80100562 <panic>
    *pte = pa | perm | PTE_P;
80107958:	8b 45 18             	mov    0x18(%ebp),%eax
8010795b:	0b 45 14             	or     0x14(%ebp),%eax
8010795e:	83 c8 01             	or     $0x1,%eax
80107961:	89 c2                	mov    %eax,%edx
80107963:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107966:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107968:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010796b:	3b 45 f0             	cmp    -0x10(%ebp),%eax
8010796e:	75 08                	jne    80107978 <mappages+0x86>
      break;
80107970:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
  ...
  return 0;
80107971:	b8 00 00 00 00       	mov    $0x0,%eax
80107976:	eb 10                	jmp    80107988 <mappages+0x96>
    a += PGSIZE;
80107978:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
8010797f:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107986:	eb 8e                	jmp    80107916 <mappages+0x24>
}
80107988:	c9                   	leave  
80107989:	c3                   	ret    
...
8010798e:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107991:	e8 13 b2 ff ff       	call   80102ba9 <kalloc>
80107996:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107999:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010799d:	75 0a                	jne    801079a9 <setupkvm+0x1f>
    return 0;
8010799f:	b8 00 00 00 00       	mov    $0x0,%eax
801079a4:	e9 84 00 00 00       	jmp    80107a2d <setupkvm+0xa3>
  memset(pgdir, 0, PGSIZE);
801079a9:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801079b0:	00 
801079b1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801079b8:	00 
801079b9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801079bc:	89 04 24             	mov    %eax,(%esp)
801079bf:	e8 46 d6 ff ff       	call   8010500a <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801079c4:	c7 45 f4 80 b4 10 80 	movl   $0x8010b480,-0xc(%ebp)
801079cb:	eb 54                	jmp    80107a21 <setupkvm+0x97>
...
801079ec:	89 4c 24 10          	mov    %ecx,0x10(%esp)
801079f0:	89 54 24 0c          	mov    %edx,0xc(%esp)
801079f4:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801079f8:	89 44 24 04          	mov    %eax,0x4(%esp)
801079fc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801079ff:	89 04 24             	mov    %eax,(%esp)
80107a02:	e8 eb fe ff ff       	call   801078f2 <mappages>
80107a07:	85 c0                	test   %eax,%eax
80107a09:	79 12                	jns    80107a1d <setupkvm+0x93>
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
80107a0b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107a0e:	89 04 24             	mov    %eax,(%esp)
80107a11:	e8 26 05 00 00       	call   80107f3c <freevm>
      return 0;
80107a16:	b8 00 00 00 00       	mov    $0x0,%eax
80107a1b:	eb 10                	jmp    80107a2d <setupkvm+0xa3>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107a1d:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107a21:	81 7d f4 c0 b4 10 80 	cmpl   $0x8010b4c0,-0xc(%ebp)
80107a28:	72 a3                	jb     801079cd <setupkvm+0x43>
    }
  return pgdir;
80107a2a:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
80107a2d:	83 c4 34             	add    $0x34,%esp
80107a30:	5b                   	pop    %ebx
80107a31:	5d                   	pop    %ebp
80107a32:	c3                   	ret    
...
80107a36:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107a39:	e8 4c ff ff ff       	call   8010798a <setupkvm>
80107a3e:	a3 24 65 11 80       	mov    %eax,0x80116524
  switchkvm();
80107a43:	e8 02 00 00 00       	call   80107a4a <switchkvm>
}
80107a48:	c9                   	leave  
80107a49:	c3                   	ret    
...
80107a50:	a1 24 65 11 80       	mov    0x80116524,%eax
80107a55:	05 00 00 00 80       	add    $0x80000000,%eax
80107a5a:	89 04 24             	mov    %eax,(%esp)
80107a5d:	e8 92 fa ff ff       	call   801074f4 <lcr3>
}
80107a62:	c9                   	leave  
80107a63:	c3                   	ret    
...
80107a6a:	83 ec 1c             	sub    $0x1c,%esp
  if(p == 0)
80107a6d:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80107a71:	75 0c                	jne    80107a7f <switchuvm+0x1b>
    panic("switchuvm: no process");
80107a73:	c7 04 24 7e 88 10 80 	movl   $0x8010887e,(%esp)
80107a7a:	e8 e3 8a ff ff       	call   80100562 <panic>
  if(p->kstack == 0)
80107a7f:	8b 45 08             	mov    0x8(%ebp),%eax
80107a82:	8b 40 08             	mov    0x8(%eax),%eax
80107a85:	85 c0                	test   %eax,%eax
80107a87:	75 0c                	jne    80107a95 <switchuvm+0x31>
    panic("switchuvm: no kstack");
80107a89:	c7 04 24 94 88 10 80 	movl   $0x80108894,(%esp)
80107a90:	e8 cd 8a ff ff       	call   80100562 <panic>
  if(p->pgdir == 0)
80107a95:	8b 45 08             	mov    0x8(%ebp),%eax
80107a98:	8b 40 04             	mov    0x4(%eax),%eax
80107a9b:	85 c0                	test   %eax,%eax
80107a9d:	75 0c                	jne    80107aab <switchuvm+0x47>
    panic("switchuvm: no pgdir");
80107a9f:	c7 04 24 a9 88 10 80 	movl   $0x801088a9,(%esp)
80107aa6:	e8 b7 8a ff ff       	call   80100562 <panic>

  pushcli();
80107aab:	e8 55 d4 ff ff       	call   80104f05 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80107ab0:	e8 36 c6 ff ff       	call   801040eb <mycpu>
80107ab5:	89 c3                	mov    %eax,%ebx
80107ab7:	e8 2f c6 ff ff       	call   801040eb <mycpu>
80107abc:	83 c0 08             	add    $0x8,%eax
80107abf:	89 c7                	mov    %eax,%edi
80107ac1:	e8 25 c6 ff ff       	call   801040eb <mycpu>
...
80107ad6:	c1 e8 18             	shr    $0x18,%eax
80107ad9:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80107ae0:	67 00 
80107ae2:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80107ae9:	89 f1                	mov    %esi,%ecx
80107aeb:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80107af1:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107af8:	83 e2 f0             	and    $0xfffffff0,%edx
80107afb:	83 ca 09             	or     $0x9,%edx
80107afe:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107b04:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107b0b:	83 ca 10             	or     $0x10,%edx
80107b0e:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107b14:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107b1b:	83 e2 9f             	and    $0xffffff9f,%edx
80107b1e:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107b24:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107b2b:	83 ca 80             	or     $0xffffff80,%edx
80107b2e:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107b34:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107b3b:	83 e2 f0             	and    $0xfffffff0,%edx
80107b3e:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b44:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107b4b:	83 e2 ef             	and    $0xffffffef,%edx
80107b4e:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b54:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107b5b:	83 e2 df             	and    $0xffffffdf,%edx
80107b5e:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b64:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107b6b:	83 ca 40             	or     $0x40,%edx
80107b6e:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b74:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107b7b:	83 e2 7f             	and    $0x7f,%edx
80107b7e:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b84:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80107b8a:	e8 5c c5 ff ff       	call   801040eb <mycpu>
...
80107ba4:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80107baa:	e8 3c c5 ff ff       	call   801040eb <mycpu>
80107baf:	8b 55 08             	mov    0x8(%ebp),%edx
80107bb2:	8b 52 08             	mov    0x8(%edx),%edx
80107bb5:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107bbb:	89 50 0c             	mov    %edx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107bbe:	e8 28 c5 ff ff       	call   801040eb <mycpu>
80107bc3:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  ltr(SEG_TSS << 3);
80107bc9:	c7 04 24 28 00 00 00 	movl   $0x28,(%esp)
80107bd0:	e8 09 f9 ff ff       	call   801074de <ltr>
...
80107be3:	e8 0c f9 ff ff       	call   801074f4 <lcr3>
  popcli();
80107be8:	e8 64 d3 ff ff       	call   80104f51 <popcli>
}
80107bed:	83 c4 1c             	add    $0x1c,%esp
80107bf0:	5b                   	pop    %ebx
80107bf1:	5e                   	pop    %esi
80107bf2:	5f                   	pop    %edi
80107bf3:	5d                   	pop    %ebp
...
80107bf8:	83 ec 38             	sub    $0x38,%esp
  char *mem;

  if(sz >= PGSIZE)
80107bfb:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107c02:	76 0c                	jbe    80107c10 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107c04:	c7 04 24 bd 88 10 80 	movl   $0x801088bd,(%esp)
80107c0b:	e8 52 89 ff ff       	call   80100562 <panic>
  mem = kalloc();
80107c10:	e8 94 af ff ff       	call   80102ba9 <kalloc>
...
80107c2e:	e8 d7 d3 ff ff       	call   8010500a <memset>
...
80107c5d:	e8 90 fc ff ff       	call   801078f2 <mappages>
  memmove(mem, init, sz);
...
80107c76:	e8 5e d4 ff ff       	call   801050d9 <memmove>
}
80107c7b:	c9                   	leave  
80107c7c:	c3                   	ret    
...
80107c80:	83 ec 28             	sub    $0x28,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80107c83:	8b 45 0c             	mov    0xc(%ebp),%eax
80107c86:	25 ff 0f 00 00       	and    $0xfff,%eax
80107c8b:	85 c0                	test   %eax,%eax
80107c8d:	74 0c                	je     80107c9b <loaduvm+0x1e>
    panic("loaduvm: addr must be page aligned");
80107c8f:	c7 04 24 d8 88 10 80 	movl   $0x801088d8,(%esp)
80107c96:	e8 c7 88 ff ff       	call   80100562 <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107c9b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107ca2:	e9 a6 00 00 00       	jmp    80107d4d <loaduvm+0xd0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107ca7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107caa:	8b 55 0c             	mov    0xc(%ebp),%edx
80107cad:	01 d0                	add    %edx,%eax
80107caf:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107cb6:	00 
80107cb7:	89 44 24 04          	mov    %eax,0x4(%esp)
80107cbb:	8b 45 08             	mov    0x8(%ebp),%eax
80107cbe:	89 04 24             	mov    %eax,(%esp)
80107cc1:	e8 90 fb ff ff       	call   80107856 <walkpgdir>
80107cc6:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107cc9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107ccd:	75 0c                	jne    80107cdb <loaduvm+0x5e>
      panic("loaduvm: address should exist");
80107ccf:	c7 04 24 fb 88 10 80 	movl   $0x801088fb,(%esp)
80107cd6:	e8 87 88 ff ff       	call   80100562 <panic>
    pa = PTE_ADDR(*pte);
80107cdb:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107cde:	8b 00                	mov    (%eax),%eax
80107ce0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107ce5:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80107ce8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ceb:	8b 55 18             	mov    0x18(%ebp),%edx
80107cee:	29 c2                	sub    %eax,%edx
80107cf0:	89 d0                	mov    %edx,%eax
80107cf2:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107cf7:	77 0f                	ja     80107d08 <loaduvm+0x8b>
      n = sz - i;
80107cf9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cfc:	8b 55 18             	mov    0x18(%ebp),%edx
80107cff:	29 c2                	sub    %eax,%edx
80107d01:	89 d0                	mov    %edx,%eax
80107d03:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107d06:	eb 07                	jmp    80107d0f <loaduvm+0x92>
    else
      n = PGSIZE;
80107d08:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107d0f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d12:	8b 55 14             	mov    0x14(%ebp),%edx
80107d15:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80107d18:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107d1b:	05 00 00 00 80       	add    $0x80000000,%eax
80107d20:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107d23:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107d27:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80107d2b:	89 44 24 04          	mov    %eax,0x4(%esp)
80107d2f:	8b 45 10             	mov    0x10(%ebp),%eax
80107d32:	89 04 24             	mov    %eax,(%esp)
80107d35:	e8 c0 a0 ff ff       	call   80101dfa <readi>
80107d3a:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107d3d:	74 07                	je     80107d46 <loaduvm+0xc9>
      return -1;
80107d3f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107d44:	eb 18                	jmp    80107d5e <loaduvm+0xe1>
  for(i = 0; i < sz; i += PGSIZE){
80107d46:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107d4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d50:	3b 45 18             	cmp    0x18(%ebp),%eax
80107d53:	0f 82 4e ff ff ff    	jb     80107ca7 <loaduvm+0x2a>
  }
  return 0;
...
80107d63:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80107d6b:	79 0a                	jns    80107d77 <allocuvm+0x17>
    return 0;
80107d6d:	b8 00 00 00 00       	mov    $0x0,%eax
80107d72:	e9 fd 00 00 00       	jmp    80107e74 <allocuvm+0x114>
  if(newsz < oldsz)
80107d77:	8b 45 10             	mov    0x10(%ebp),%eax
80107d7a:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107d7d:	73 08                	jae    80107d87 <allocuvm+0x27>
    return oldsz;
80107d7f:	8b 45 0c             	mov    0xc(%ebp),%eax
80107d82:	e9 ed 00 00 00       	jmp    80107e74 <allocuvm+0x114>
...
80107d97:	e9 c9 00 00 00       	jmp    80107e65 <allocuvm+0x105>
    mem = kalloc();
80107d9c:	e8 08 ae ff ff       	call   80102ba9 <kalloc>
80107da1:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80107da4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107da8:	75 2f                	jne    80107dd9 <allocuvm+0x79>
      cprintf("allocuvm out of memory\n");
80107daa:	c7 04 24 19 89 10 80 	movl   $0x80108919,(%esp)
80107db1:	e8 12 86 ff ff       	call   801003c8 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80107db6:	8b 45 0c             	mov    0xc(%ebp),%eax
80107db9:	89 44 24 08          	mov    %eax,0x8(%esp)
80107dbd:	8b 45 10             	mov    0x10(%ebp),%eax
80107dc0:	89 44 24 04          	mov    %eax,0x4(%esp)
80107dc4:	8b 45 08             	mov    0x8(%ebp),%eax
80107dc7:	89 04 24             	mov    %eax,(%esp)
80107dca:	e8 a7 00 00 00       	call   80107e76 <deallocuvm>
      return 0;
80107dcf:	b8 00 00 00 00       	mov    $0x0,%eax
80107dd4:	e9 9b 00 00 00       	jmp    80107e74 <allocuvm+0x114>
    }
    memset(mem, 0, PGSIZE);
...
80107def:	e8 16 d2 ff ff       	call   8010500a <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80107df4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107df7:	8d 90 00 00 00 80    	lea    -0x80000000(%eax),%edx
80107dfd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e00:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107e07:	00 
80107e08:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107e0c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107e13:	00 
80107e14:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e18:	8b 45 08             	mov    0x8(%ebp),%eax
80107e1b:	89 04 24             	mov    %eax,(%esp)
80107e1e:	e8 cf fa ff ff       	call   801078f2 <mappages>
80107e23:	85 c0                	test   %eax,%eax
80107e25:	79 37                	jns    80107e5e <allocuvm+0xfe>
      cprintf("allocuvm out of memory (2)\n");
80107e27:	c7 04 24 31 89 10 80 	movl   $0x80108931,(%esp)
80107e2e:	e8 95 85 ff ff       	call   801003c8 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80107e33:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e36:	89 44 24 08          	mov    %eax,0x8(%esp)
80107e3a:	8b 45 10             	mov    0x10(%ebp),%eax
80107e3d:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e41:	8b 45 08             	mov    0x8(%ebp),%eax
80107e44:	89 04 24             	mov    %eax,(%esp)
80107e47:	e8 2a 00 00 00       	call   80107e76 <deallocuvm>
      kfree(mem);
80107e4c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107e4f:	89 04 24             	mov    %eax,(%esp)
80107e52:	e8 bc ac ff ff       	call   80102b13 <kfree>
      return 0;
80107e57:	b8 00 00 00 00       	mov    $0x0,%eax
80107e5c:	eb 16                	jmp    80107e74 <allocuvm+0x114>
  for(; a < newsz; a += PGSIZE){
80107e5e:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107e65:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e68:	3b 45 10             	cmp    0x10(%ebp),%eax
80107e6b:	0f 82 2b ff ff ff    	jb     80107d9c <allocuvm+0x3c>
    }
  }
  return newsz;
...
80107e79:	83 ec 28             	sub    $0x28,%esp
  ...
  if(newsz >= oldsz)
80107e7c:	8b 45 10             	mov    0x10(%ebp),%eax
80107e7f:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107e82:	72 08                	jb     80107e8c <deallocuvm+0x16>
    return oldsz;
80107e84:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e87:	e9 ae 00 00 00       	jmp    80107f3a <deallocuvm+0xc4>

  a = PGROUNDUP(newsz);
80107e8c:	8b 45 10             	mov    0x10(%ebp),%eax
80107e8f:	05 ff 0f 00 00       	add    $0xfff,%eax
80107e94:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107e99:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80107e9c:	e9 8a 00 00 00       	jmp    80107f2b <deallocuvm+0xb5>
...
80107eb6:	e8 9b f9 ff ff       	call   80107856 <walkpgdir>
80107ebb:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80107ebe:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107ec2:	75 16                	jne    80107eda <deallocuvm+0x64>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80107ec4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ec7:	c1 e8 16             	shr    $0x16,%eax
80107eca:	83 c0 01             	add    $0x1,%eax
80107ecd:	c1 e0 16             	shl    $0x16,%eax
80107ed0:	2d 00 10 00 00       	sub    $0x1000,%eax
80107ed5:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107ed8:	eb 4a                	jmp    80107f24 <deallocuvm+0xae>
    else if((*pte & PTE_P) != 0){
80107eda:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107edd:	8b 00                	mov    (%eax),%eax
80107edf:	83 e0 01             	and    $0x1,%eax
80107ee2:	85 c0                	test   %eax,%eax
80107ee4:	74 3e                	je     80107f24 <deallocuvm+0xae>
      pa = PTE_ADDR(*pte);
...
80107ef7:	75 0c                	jne    80107f05 <deallocuvm+0x8f>
        panic("kfree");
80107ef9:	c7 04 24 4d 89 10 80 	movl   $0x8010894d,(%esp)
...
80107f3f:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
80107f42:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80107f46:	75 0c                	jne    80107f54 <freevm+0x18>
    panic("freevm: no pgdir");
80107f48:	c7 04 24 53 89 10 80 	movl   $0x80108953,(%esp)
80107f4f:	e8 0e 86 ff ff       	call   80100562 <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80107f54:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107f5b:	00 
80107f5c:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80107f63:	80 
80107f64:	8b 45 08             	mov    0x8(%ebp),%eax
80107f67:	89 04 24             	mov    %eax,(%esp)
80107f6a:	e8 07 ff ff ff       	call   80107e76 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80107f6f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107f76:	eb 45                	jmp    80107fbd <freevm+0x81>
    if(pgdir[i] & PTE_P){
...
80107f8e:	74 29                	je     80107fb9 <freevm+0x7d>
...
80107fa1:	25 00 f0 ff ff       	and    $0xfffff000,%eax
...
80107fb4:	e8 5a ab ff ff       	call   80102b13 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
80107fb9:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80107fbd:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80107fc4:	76 b2                	jbe    80107f78 <freevm+0x3c>
    }
  }
  kfree((char*)pgdir);
...
80107fee:	e8 63 f8 ff ff       	call   80107856 <walkpgdir>
80107ff3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80107ff6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107ffa:	75 0c                	jne    80108008 <clearpteu+0x35>
    panic("clearpteu");
80107ffc:	c7 04 24 64 89 10 80 	movl   $0x80108964,(%esp)
80108003:	e8 5a 85 ff ff       	call   80100562 <panic>
  *pte &= ~PTE_U;
80108008:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010800b:	8b 00                	mov    (%eax),%eax
8010800d:	83 e0 fb             	and    $0xfffffffb,%eax
80108010:	89 c2                	mov    %eax,%edx
80108012:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108015:	89 10                	mov    %edx,(%eax)
}
80108017:	c9                   	leave  
80108018:	c3                   	ret    
...
8010801c:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
8010801f:	e8 66 f9 ff ff       	call   8010798a <setupkvm>
80108024:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108027:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010802b:	75 0a                	jne    80108037 <copyuvm+0x1e>
    return 0;
8010802d:	b8 00 00 00 00       	mov    $0x0,%eax
80108032:	e9 03 01 00 00       	jmp    8010813a <copyuvm+0x121>
  for(i = 0; i < sz; i += PGSIZE){
80108037:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010803e:	e9 d6 00 00 00       	jmp    80108119 <copyuvm+0x100>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108043:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108046:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010804d:	00 
8010804e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108052:	8b 45 08             	mov    0x8(%ebp),%eax
80108055:	89 04 24             	mov    %eax,(%esp)
80108058:	e8 f9 f7 ff ff       	call   80107856 <walkpgdir>
8010805d:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108060:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108064:	75 0c                	jne    80108072 <copyuvm+0x59>
      panic("copyuvm: pte should exist");
80108066:	c7 04 24 6e 89 10 80 	movl   $0x8010896e,(%esp)
8010806d:	e8 f0 84 ff ff       	call   80100562 <panic>
    if(!(*pte & PTE_P))
80108072:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108075:	8b 00                	mov    (%eax),%eax
80108077:	83 e0 01             	and    $0x1,%eax
8010807a:	85 c0                	test   %eax,%eax
8010807c:	75 0c                	jne    8010808a <copyuvm+0x71>
      panic("copyuvm: page not present");
8010807e:	c7 04 24 88 89 10 80 	movl   $0x80108988,(%esp)
...
801080a1:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
801080a4:	e8 00 ab ff ff       	call   80102ba9 <kalloc>
801080a9:	89 45 e0             	mov    %eax,-0x20(%ebp)
801080ac:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801080b0:	75 02                	jne    801080b4 <copyuvm+0x9b>
      goto bad;
801080b2:	eb 76                	jmp    8010812a <copyuvm+0x111>
...
801080c8:	8b 45 e0             	mov    -0x20(%ebp),%eax
801080cb:	89 04 24             	mov    %eax,(%esp)
801080ce:	e8 06 d0 ff ff       	call   801050d9 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
801080d3:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801080d6:	8b 45 e0             	mov    -0x20(%ebp),%eax
801080d9:	8d 88 00 00 00 80    	lea    -0x80000000(%eax),%ecx
801080df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080e2:	89 54 24 10          	mov    %edx,0x10(%esp)
801080e6:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
...
801080fc:	e8 f1 f7 ff ff       	call   801078f2 <mappages>
80108101:	85 c0                	test   %eax,%eax
80108103:	79 0d                	jns    80108112 <copyuvm+0xf9>
      kfree(mem);
80108105:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108108:	89 04 24             	mov    %eax,(%esp)
8010810b:	e8 03 aa ff ff       	call   80102b13 <kfree>
      goto bad;
80108110:	eb 18                	jmp    8010812a <copyuvm+0x111>
  for(i = 0; i < sz; i += PGSIZE){
80108112:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108119:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010811c:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010811f:	0f 82 1e ff ff ff    	jb     80108043 <copyuvm+0x2a>
    }
  }
  return d;
80108125:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108128:	eb 10                	jmp    8010813a <copyuvm+0x121>

bad:
  freevm(d);
8010812a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010812d:	89 04 24             	mov    %eax,(%esp)
80108130:	e8 07 fe ff ff       	call   80107f3c <freevm>
  return 0;
...
8010813f:	83 ec 28             	sub    $0x28,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
80108142:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108149:	00 
...
801081bf:	e8 78 ff ff ff       	call   8010813c <uva2ka>
...
80108212:	e8 c2 ce ff ff       	call   801050d9 <memmove>
    len -= n;
