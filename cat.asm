...
cat(int fd)
{
  ...
  1e:	e8 b0 03 00 00       	call   3d3 <write>
  ...
  37:	e8 f7 04 00 00       	call   533 <printf>
      exit();
  3c:	e8 72 03 00 00       	call   3b3 <exit>
  while((n = read(fd, buf, sizeof(buf))) > 0) {
  ...
  57:	e8 6f 03 00 00       	call   3cb <read>
  ...
  7a:	e8 b4 04 00 00       	call   533 <printf>
    exit();
  7f:	e8 2f 03 00 00       	call   3b3 <exit>
  }
}
  84:	c9                   	leave  
  85:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  cd:	e8 21 03 00 00       	call   3f3 <open>
 ...
 102:	e8 2c 04 00 00       	call   533 <printf>
      exit();
 107:	e8 a7 02 00 00       	call   3b3 <exit>
    }
    cat(fd);
 ...
 11f:	e8 b7 02 00 00       	call   3db <close>
  for(i = 1; i < argc; i++){
...
gets(char *buf, int max)
{
 ...
 272:	e8 54 01 00 00       	call   3cb <read>
...
stat(const char *n, struct stat *st)
{
 ...
 2d7:	e8 17 01 00 00       	call   3f3 <open>
...
putc(int fd, char c)
{
 ...
 474:	e8 5a ff ff ff       	call   3d3 <write>
}
 479:	c9                   	leave  
 47a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7e6:	e8 50 fc ff ff       	call   43b <sbrk>
