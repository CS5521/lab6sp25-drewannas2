...
wc(int fd, char *name)
{
  ...
  a0:	e8 c4 03 00 00       	call   469 <read>
  ...
  c7:	e8 05 05 00 00       	call   5d1 <printf>
    exit();
  cc:	e8 80 03 00 00       	call   451 <exit>
  }
  printf(1, "%d %d %d %s\n", l, w, c, name);
...
main(int argc, char *argv[])
{
 ...
 121:	e8 da fe ff ff       	call   0 <wc>
    exit();
 126:	e8 26 03 00 00       	call   451 <exit>
  }
 ...
 155:	e8 37 03 00 00       	call   491 <open>
 ...
 18a:	e8 42 04 00 00       	call   5d1 <printf>
      exit();
 18f:	e8 bd 02 00 00       	call   451 <exit>
    }
    wc(fd, argv[i]);
 ...
 1bd:	e8 b7 02 00 00       	call   479 <close>
  for(i = 1; i < argc; i++){
 ...
 1ce:	0f 8c 64 ff ff ff    	jl     138 <main+0x35>
  ...
  exit();
 1d4:	e8 78 02 00 00       	call   451 <exit>
...
gets(char *buf, int max)
{
 ...
 310:	e8 54 01 00 00       	call   469 <read>
...
stat(const char *n, struct stat *st)
{
 ...
 375:	e8 17 01 00 00       	call   491 <open>
...
putc(int fd, char c)
{
 ...
 512:	e8 5a ff ff ff       	call   471 <write>
}
 517:	c9                   	leave  
 518:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 884:	e8 50 fc ff ff       	call   4d9 <sbrk>
