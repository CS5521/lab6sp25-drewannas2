...
main(int argc, char **argv)
{
  ...
  1e:	e8 3c 04 00 00       	call   45f <printf>
    exit();
  23:	e8 b7 02 00 00       	call   2df <exit>
  }
  for(i=1; i<argc; i++)
  ...
  4f:	e8 bb 02 00 00       	call   30f <kill>
  for(i=1; i<argc; i++)
  ...
  exit();
  62:	e8 78 02 00 00       	call   2df <exit>
...
gets(char *buf, int max)
{
 ...
 19e:	e8 54 01 00 00       	call   2f7 <read>
...
stat(const char *n, struct stat *st)
{
 ...
 203:	e8 17 01 00 00       	call   31f <open>
...
putc(int fd, char c)
{
 ...
 3a0:	e8 5a ff ff ff       	call   2ff <write>
}
 3a5:	c9                   	leave  
 3a6:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 712:	e8 50 fc ff ff       	call   367 <sbrk>
