...
main(int argc, char * argv[]) {
   ...
   3:	83 e4 f0             	and    $0xfffffff0,%esp
	hw();
   6:	e8 6d 02 00 00       	call   278 <hw>
	exit();
   b:	e8 78 02 00 00       	call   288 <exit>
...
gets(char *buf, int max)
{
 ...
 147:	e8 54 01 00 00       	call   2a0 <read>
...
stat(const char *n, struct stat *st)
{
 ...
 1ac:	e8 17 01 00 00       	call   2c8 <open>
 ...
 1ce:	e8 0d 01 00 00       	call   2e0 <fstat>
 1d3:	89 45 f0             	mov    %eax,-0x10(%ebp)
  close(fd);
 1d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
 1d9:	89 04 24             	mov    %eax,(%esp)
 1dc:	e8 cf 00 00 00       	call   2b0 <close>
  return r;
...
SYSCALL(fkc)
 270:	b8 17 00 00 00       	mov    $0x17,%eax
 275:	cd 40                	int    $0x40
 277:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 6bb:	e8 50 fc ff ff       	call   310 <sbrk>
