...
main(void)
{
  ...
  18:	e8 aa 03 00 00       	call   3c7 <open>
  ...
  38:	e8 92 03 00 00       	call   3cf <mknod>
    open("console", O_RDWR);
  3d:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  44:	00 
  45:	c7 04 24 d6 08 00 00 	movl   $0x8d6,(%esp)
  4c:	e8 76 03 00 00       	call   3c7 <open>
  }
  dup(0);  // stdout
  51:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  58:	e8 a2 03 00 00       	call   3ff <dup>
  dup(0);  // stderr
  5d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  64:	e8 96 03 00 00       	call   3ff <dup>
  ...
  78:	e8 8a 04 00 00       	call   507 <printf>
    pid = fork();
  7d:	e8 fd 02 00 00       	call   37f <fork>
  ...
  9c:	e8 66 04 00 00       	call   507 <printf>
      exit();
  a1:	e8 e1 02 00 00       	call   387 <exit>
    }
    if(pid == 0){
  ...
  bc:	e8 fe 02 00 00       	call   3bf <exec>
  ...
  d0:	e8 32 04 00 00       	call   507 <printf>
      exit();
  d5:	e8 ad 02 00 00       	call   387 <exit>
    }
  ...
  eb:	e8 17 04 00 00       	call   507 <printf>
    while((wpid=wait()) >= 0 && wpid != pid)
  f0:	e8 9a 02 00 00       	call   38f <wait>
...
gets(char *buf, int max)
{
 ...
 246:	e8 54 01 00 00       	call   39f <read>
...
stat(const char *n, struct stat *st)
{
 ...
 2ab:	e8 17 01 00 00       	call   3c7 <open>
...
putc(int fd, char c)
{
 ...
 448:	e8 5a ff ff ff       	call   3a7 <write>
}
 44d:	c9                   	leave  
 44e:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7ba:	e8 50 fc ff ff       	call   40f <sbrk>
