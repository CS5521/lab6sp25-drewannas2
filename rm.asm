...
main(int argc, char *argv[])
{
  ...
  1e:	e8 64 04 00 00       	call   487 <printf>
    exit();
  23:	e8 df 02 00 00       	call   307 <exit>
  }
  ...
  47:	e8 0b 03 00 00       	call   357 <unlink>
  ...
  exit();
  8a:	e8 78 02 00 00       	call   307 <exit>
...
gets(char *buf, int max)
{
 ...
 1c6:	e8 54 01 00 00       	call   31f <read>
...
stat(const char *n, struct stat *st)
{
 ...
 22b:	e8 17 01 00 00       	call   347 <open>
...
putc(int fd, char c)
{
 ...
 3c8:	e8 5a ff ff ff       	call   327 <write>
}
 3cd:	c9                   	leave  
 3ce:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 73a:	e8 50 fc ff ff       	call   38f <sbrk>
