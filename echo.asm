...
main(int argc, char *argv[])
{
  ...
  exit();
  67:	e8 78 02 00 00       	call   2e4 <exit>
...
gets(char *buf, int max)
{
 ...
 1a3:	e8 54 01 00 00       	call   2fc <read>
...
stat(const char *n, struct stat *st)
{
 ...
 208:	e8 17 01 00 00       	call   324 <open>
...
morecore(uint nu)
{
 ...
 717:	e8 50 fc ff ff       	call   36c <sbrk>
