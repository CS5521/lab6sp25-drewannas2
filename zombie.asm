...
main(void)
{
  ...
  if(fork() > 0)
   9:	e8 85 02 00 00       	call   293 <fork>
   e:	85 c0                	test   %eax,%eax
  10:	7e 0c                	jle    1e <main+0x1e>
    sleep(5);  // Let child exit before parent.
  12:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  19:	e8 0d 03 00 00       	call   32b <sleep>
  exit();
  1e:	e8 78 02 00 00       	call   29b <exit>
...
gets(char *buf, int max)
{
 ...
 15a:	e8 54 01 00 00       	call   2b3 <read>
...
stat(const char *n, struct stat *st)
{
 ...
 1bf:	e8 17 01 00 00       	call   2db <open>
 ...
 1e1:	e8 0d 01 00 00       	call   2f3 <fstat>
 1e6:	89 45 f0             	mov    %eax,-0x10(%ebp)
  close(fd);
 1e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
 1ec:	89 04 24             	mov    %eax,(%esp)
 1ef:	e8 cf 00 00 00       	call   2c3 <close>
  return r;
...
putc(int fd, char c)
{
 ...
 35c:	e8 5a ff ff ff       	call   2bb <write>
}
 361:	c9                   	leave  
 362:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 6ce:	e8 50 fc ff ff       	call   323 <sbrk>
