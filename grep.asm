...
grep(char *pattern, int fd)
{
  ...
  6f:	e8 84 05 00 00       	call   5f8 <write>
      }
      p = q+1;
  ...
  fb:	e8 f0 04 00 00       	call   5f0 <read>
...
main(int argc, char *argv[])
{
 ...
 12d:	e8 26 06 00 00       	call   758 <printf>
    exit();
 132:	e8 a1 04 00 00       	call   5d8 <exit>
  }
  pattern = argv[1];
 ...
 156:	e8 a5 fe ff ff       	call   0 <grep>
    exit();
 15b:	e8 78 04 00 00       	call   5d8 <exit>
  }
 ...
 18a:	e8 89 04 00 00       	call   618 <open>
 ...
 1bf:	e8 94 05 00 00       	call   758 <printf>
      exit();
 1c4:	e8 0f 04 00 00       	call   5d8 <exit>
    }
    grep(pattern, fd);
 ...
 1e4:	e8 17 04 00 00       	call   600 <close>
  for(i = 2; i < argc; i++){
 ...
 1f5:	0f 8c 72 ff ff ff    	jl     16d <main+0x5e>
  ...
  exit();
 1fb:	e8 d8 03 00 00       	call   5d8 <exit>
...
gets(char *buf, int max)
{
 ...
 497:	e8 54 01 00 00       	call   5f0 <read>
...
stat(const char *n, struct stat *st)
{
 ...
 4fc:	e8 17 01 00 00       	call   618 <open>
...
putc(int fd, char c)
{
 ...
 699:	e8 5a ff ff ff       	call   5f8 <write>
}
 69e:	c9                   	leave  
 69f:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a0b:	e8 50 fc ff ff       	call   660 <sbrk>
