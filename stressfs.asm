...
main(int argc, char *argv[])
{
  ...
  67:	eb 13                	jmp    7c <main+0x7c>
    if(fork() > 0)
  69:	e8 b5 03 00 00       	call   423 <fork>
  ...
  d1:	e8 95 03 00 00       	call   46b <open>
...
//    printf(fd, "%d\n", i);
 ...
 104:	e8 42 03 00 00       	call   44b <write>
  for(i = 0; i < 20; i++)
 ...
 125:	e8 29 03 00 00       	call   453 <close>
 ...
 150:	e8 16 03 00 00       	call   46b <open>
 ...
 183:	e8 bb 02 00 00       	call   443 <read>
  for (i = 0; i < 20; i++)
 ...
 1a4:	e8 aa 02 00 00       	call   453 <close>

  wait();
 1a9:	e8 85 02 00 00       	call   433 <wait>

  exit();
 1ae:	e8 78 02 00 00       	call   42b <exit>
...
gets(char *buf, int max)
{
 ...
 2ea:	e8 54 01 00 00       	call   443 <read>
...
stat(const char *n, struct stat *st)
{
 ...
 34f:	e8 17 01 00 00       	call   46b <open>
 ...
 371:	e8 0d 01 00 00       	call   483 <fstat>
 376:	89 45 f0             	mov    %eax,-0x10(%ebp)
  close(fd);
 379:	8b 45 f4             	mov    -0xc(%ebp),%eax
 37c:	89 04 24             	mov    %eax,(%esp)
 37f:	e8 cf 00 00 00       	call   453 <close>
  return r;
...
putc(int fd, char c)
{
 ...
 4ec:	e8 5a ff ff ff       	call   44b <write>
}
 4f1:	c9                   	leave  
 4f2:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 85e:	e8 50 fc ff ff       	call   4b3 <sbrk>
